...
<<<<<<<< HEAD:database/migrations/2024_02_24_000081_add_relationship_fields_to_wlists_table.php
========
            $table->unsignedBigInteger('financial_document_id')->nullable();
            $table->foreign('financial_document_id', 'financial_document_fk_9582914')->references('id')->on('finalcial_documents');
>>>>>>>> master:database/migrations/2024_03_10_000128_add_relationship_fields_to_wlists_table.php
        });
    }
}
