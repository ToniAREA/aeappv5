    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-contacts.update", [$contactContact->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_nif') ? 'is-invalid' : '' }}" type="text" name="contact_nif" id="contact_nif" value="{{ old('contact_nif', $contactContact->contact_nif) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_country') ? 'is-invalid' : '' }}" type="text" name="contact_country" id="contact_country" value="{{ old('contact_country', $contactContact->contact_country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_email_2') ? 'is-invalid' : '' }}" type="text" name="contact_email_2" id="contact_email_2" value="{{ old('contact_email_2', $contactContact->contact_email_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_tags') ? 'is-invalid' : '' }}" type="text" name="contact_tags" id="contact_tags" value="{{ old('contact_tags', $contactContact->contact_tags) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_notes') ? 'is-invalid' : '' }}" type="text" name="contact_notes" id="contact_notes" value="{{ old('contact_notes', $contactContact->contact_notes) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_internalnotes') ? 'is-invalid' : '' }}" type="text" name="contact_internalnotes" id="contact_internalnotes" value="{{ old('contact_internalnotes', $contactContact->contact_internalnotes) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link" value="{{ old('link', $contactContact->link) }}">
                @if($errors->has('link'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_description') ? 'is-invalid' : '' }}" type="text" name="link_description" id="link_description" value="{{ old('link_description', $contactContact->link_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_use') ? 'is-invalid' : '' }}" type="text" name="last_use" id="last_use" value="{{ old('last_use', $contactContact->last_use) }}">
