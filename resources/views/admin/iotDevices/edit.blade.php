...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.iotDevice.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.iot-devices.update", [$iotDevice->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('device') ? 'is-invalid' : '' }}" type="text" name="device" id="device" value="{{ old('device', $iotDevice->device) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product') ? 'is-invalid' : '' }}" name="product_id" id="product_id">
                    @foreach($products as $id => $entry)
                        <option value="{{ $id }}" {{ (old('product_id') ? old('product_id') : $iotDevice->product->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('security_token') ? 'is-invalid' : '' }}" type="text" name="security_token" id="security_token" value="{{ old('security_token', $iotDevice->security_token) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('serial_number') ? 'is-invalid' : '' }}" type="text" name="serial_number" id="serial_number" value="{{ old('serial_number', $iotDevice->serial_number) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\IotDevice::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $iotDevice->status) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('additional_info') ? 'is-invalid' : '' }}" name="additional_info" id="additional_info">{{ old('additional_info', $iotDevice->additional_info) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source_code_link') ? 'is-invalid' : '' }}" type="text" name="source_code_link" id="source_code_link" value="{{ old('source_code_link', $iotDevice->source_code_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" type="text" name="notes" id="notes" value="{{ old('notes', $iotDevice->notes) }}">
                @if($errors->has('notes'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('internal_notes') ? 'is-invalid' : '' }}" type="text" name="internal_notes" id="internal_notes" value="{{ old('internal_notes', $iotDevice->internal_notes) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link" value="{{ old('link', $iotDevice->link) }}">
                @if($errors->has('link'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_name') ? 'is-invalid' : '' }}" type="text" name="link_name" id="link_name" value="{{ old('link_name', $iotDevice->link_name) }}">
