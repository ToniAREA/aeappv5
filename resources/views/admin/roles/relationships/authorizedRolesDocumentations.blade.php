    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-authorizedRolesDocumentations">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <tr data-entry-id="{{ $documentation->id }}">
                                ...
                                <td>
                                    @can('documentation_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.documentations.show', $documentation->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

                                    @can('documentation_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.documentations.edit', $documentation->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('documentation_delete')
                                        <form action="{{ route('admin.documentations.destroy', $documentation->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-authorizedRolesDocumentations:not(.ajaxTable)').DataTable({ buttons: dtButtons })
