        ...
        <form method="POST" action="{{ route("admin.proformas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('closed_and_protected') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="closed_and_protected" id="closed_and_protected" value="1" {{ old('closed_and_protected', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('invoice_link') ? 'is-invalid' : '' }}" type="text" name="invoice_link" id="invoice_link" value="{{ old('invoice_link', '') }}">
