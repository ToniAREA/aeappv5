...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.iot-received-datas.update", [$iotReceivedData->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('device') ? 'is-invalid' : '' }}" name="device_id" id="device_id">
                    @foreach($devices as $id => $entry)
                        <option value="{{ $id }}" {{ (old('device_id') ? old('device_id') : $iotReceivedData->device->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('security_token') ? 'is-invalid' : '' }}" type="text" name="security_token" id="security_token" value="{{ old('security_token', $iotReceivedData->security_token) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('received_data') ? 'is-invalid' : '' }}" name="received_data" id="received_data">{{ old('received_data', $iotReceivedData->received_data) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service_voltage') ? 'is-invalid' : '' }}" type="number" name="service_voltage" id="service_voltage" value="{{ old('service_voltage', $iotReceivedData->service_voltage) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine_1_voltage') ? 'is-invalid' : '' }}" type="number" name="engine_1_voltage" id="engine_1_voltage" value="{{ old('engine_1_voltage', $iotReceivedData->engine_1_voltage) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine_2_voltage') ? 'is-invalid' : '' }}" type="number" name="engine_2_voltage" id="engine_2_voltage" value="{{ old('engine_2_voltage', $iotReceivedData->engine_2_voltage) }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('bilge_alarm') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="bilge_alarm" id="bilge_alarm" value="1" {{ $iotReceivedData->bilge_alarm || old('bilge_alarm', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('shore_alarm') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="shore_alarm" id="shore_alarm" value="1" {{ $iotReceivedData->shore_alarm || old('shore_alarm', 0) === 1 ? 'checked' : '' }}>
