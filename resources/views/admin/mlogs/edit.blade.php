    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.mlogs.update", [$mlog->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('boat_namecomplete') ? 'is-invalid' : '' }}" type="text" name="boat_namecomplete" id="boat_namecomplete" value="{{ old('boat_namecomplete', $mlog->boat_namecomplete) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item') ? 'is-invalid' : '' }}" type="text" name="item" id="item" value="{{ old('item', $mlog->item) }}">
                @if($errors->has('item'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $mlog->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('units') ? 'is-invalid' : '' }}" type="number" name="units" id="units" value="{{ old('units', $mlog->units) }}" step="0.01">
                @if($errors->has('units'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('internal_notes') ? 'is-invalid' : '' }}" type="text" name="internal_notes" id="internal_notes" value="{{ old('internal_notes', $mlog->internal_notes) }}">
