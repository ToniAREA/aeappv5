    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-financialDocumentIotSuscriptions">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <tr data-entry-id="{{ $iotSuscription->id }}">
                                ...
                                <td>
                                    @can('iot_suscription_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.iot-suscriptions.show', $iotSuscription->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

                                    @can('iot_suscription_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.iot-suscriptions.edit', $iotSuscription->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('iot_suscription_delete')
                                        <form action="{{ route('admin.iot-suscriptions.destroy', $iotSuscription->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-financialDocumentIotSuscriptions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
