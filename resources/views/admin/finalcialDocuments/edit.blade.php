...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.finalcial-documents.update", [$finalcialDocument->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                @foreach(App\Models\FinalcialDocument::DOC_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('doc_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="doc_type_{{ $key }}" name="doc_type" value="{{ $key }}" {{ old('doc_type', $finalcialDocument->doc_type) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_number') ? 'is-invalid' : '' }}" type="text" name="reference_number" id="reference_number" value="{{ old('reference_number', $finalcialDocument->reference_number) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\FinalcialDocument::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $finalcialDocument->status) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('client') ? 'is-invalid' : '' }}" name="client_id" id="client_id">
                    @foreach($clients as $id => $entry)
                        <option value="{{ $id }}" {{ (old('client_id') ? old('client_id') : $finalcialDocument->client->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('issue_date') ? 'is-invalid' : '' }}" type="text" name="issue_date" id="issue_date" value="{{ old('issue_date', $finalcialDocument->issue_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('due_date') ? 'is-invalid' : '' }}" type="text" name="due_date" id="due_date" value="{{ old('due_date', $finalcialDocument->due_date) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('currency') ? 'is-invalid' : '' }}" name="currency_id" id="currency_id">
                    @foreach($currencies as $id => $entry)
                        <option value="{{ $id }}" {{ (old('currency_id') ? old('currency_id') : $finalcialDocument->currency->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal') ? 'is-invalid' : '' }}" type="number" name="subtotal" id="subtotal" value="{{ old('subtotal', $finalcialDocument->subtotal) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_taxes') ? 'is-invalid' : '' }}" type="number" name="total_taxes" id="total_taxes" value="{{ old('total_taxes', $finalcialDocument->total_taxes) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_discounts') ? 'is-invalid' : '' }}" type="number" name="total_discounts" id="total_discounts" value="{{ old('total_discounts', $finalcialDocument->total_discounts) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_amount') ? 'is-invalid' : '' }}" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', $finalcialDocument->total_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_terms') ? 'is-invalid' : '' }}" type="text" name="payment_terms" id="payment_terms" value="{{ old('payment_terms', $finalcialDocument->payment_terms) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('security_code') ? 'is-invalid' : '' }}" type="text" name="security_code" id="security_code" value="{{ old('security_code', $finalcialDocument->security_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" type="text" name="notes" id="notes" value="{{ old('notes', $finalcialDocument->notes) }}">
                @if($errors->has('notes'))
