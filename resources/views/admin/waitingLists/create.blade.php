...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.waitingList.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.waiting-lists.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('waiting_for') ? 'is-invalid' : '' }}" type="text" name="waiting_for" id="waiting_for" value="{{ old('waiting_for', '') }}">
