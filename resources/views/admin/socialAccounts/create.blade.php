...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.social-accounts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_provider') ? 'is-invalid' : '' }}" type="text" name="id_provider" id="id_provider" value="{{ old('id_provider', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('refresh_token') ? 'is-invalid' : '' }}" type="text" name="refresh_token" id="refresh_token" value="{{ old('refresh_token', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expires_in') ? 'is-invalid' : '' }}" type="number" name="expires_in" id="expires_in" value="{{ old('expires_in', '') }}" step="1">
