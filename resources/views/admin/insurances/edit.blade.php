        ...
        <form method="POST" action="{{ route("admin.insurances.update", [$insurance->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ $insurance->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('provider_name') ? 'is-invalid' : '' }}" type="text" name="provider_name" id="provider_name" value="{{ old('provider_name', $insurance->provider_name) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Insurance::PERIOD_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('period') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="period_{{ $key }}" name="period" value="{{ $key }}" {{ old('period', $insurance->period) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_cost') ? 'is-invalid' : '' }}" type="number" name="period_cost" id="period_cost" value="{{ old('period_cost', $insurance->period_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coverage_type') ? 'is-invalid' : '' }}" type="text" name="coverage_type" id="coverage_type" value="{{ old('coverage_type', $insurance->coverage_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $insurance->start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $insurance->end_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" type="text" name="notes" id="notes" value="{{ old('notes', $insurance->notes) }}">
                @if($errors->has('notes'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('internalnotes') ? 'is-invalid' : '' }}" type="text" name="internalnotes" id="internalnotes" value="{{ old('internalnotes', $insurance->internalnotes) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_a') ? 'is-invalid' : '' }}" type="text" name="link_a" id="link_a" value="{{ old('link_a', $insurance->link_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_a_description') ? 'is-invalid' : '' }}" type="text" name="link_a_description" id="link_a_description" value="{{ old('link_a_description', $insurance->link_a_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_b') ? 'is-invalid' : '' }}" type="text" name="link_b" id="link_b" value="{{ old('link_b', $insurance->link_b) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_b_description') ? 'is-invalid' : '' }}" type="text" name="link_b_description" id="link_b_description" value="{{ old('link_b_description', $insurance->link_b_description) }}">
