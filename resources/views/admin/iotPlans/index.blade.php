                ...
                <tbody>
                    @foreach($iotPlans as $key => $iotPlan)
                        <tr data-entry-id="{{ $iotPlan->id }}">
                            ...
                            <td>
                                @can('iot_plan_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.iot-plans.show', $iotPlan->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('iot_plan_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.iot-plans.edit', $iotPlan->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('iot_plan_delete')
                                    <form action="{{ route('admin.iot-plans.destroy', $iotPlan->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
