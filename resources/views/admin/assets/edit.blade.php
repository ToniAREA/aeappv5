        ...
        <form method="POST" action="{{ route("admin.assets.update", [$asset->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_available') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_available" id="is_available" value="1" {{ $asset->is_available || old('is_available', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $asset->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('internal_notes') ? 'is-invalid' : '' }}" type="text" name="internal_notes" id="internal_notes" value="{{ old('internal_notes', $asset->internal_notes) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_1') ? 'is-invalid' : '' }}" type="text" name="data_1" id="data_1" value="{{ old('data_1', $asset->data_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_1_description') ? 'is-invalid' : '' }}" type="text" name="data_1_description" id="data_1_description" value="{{ old('data_1_description', $asset->data_1_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_2') ? 'is-invalid' : '' }}" type="text" name="data_2" id="data_2" value="{{ old('data_2', $asset->data_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_2_description') ? 'is-invalid' : '' }}" type="text" name="data_2_description" id="data_2_description" value="{{ old('data_2_description', $asset->data_2_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_a') ? 'is-invalid' : '' }}" type="text" name="link_a" id="link_a" value="{{ old('link_a', $asset->link_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_a_description') ? 'is-invalid' : '' }}" type="text" name="link_a_description" id="link_a_description" value="{{ old('link_a_description', $asset->link_a_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_b') ? 'is-invalid' : '' }}" type="text" name="link_b" id="link_b" value="{{ old('link_b', $asset->link_b) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_b_description') ? 'is-invalid' : '' }}" type="text" name="link_b_description" id="link_b_description" value="{{ old('link_b_description', $asset->link_b_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_use') ? 'is-invalid' : '' }}" type="text" name="last_use" id="last_use" value="{{ old('last_use', $asset->last_use) }}">
