    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_price') ? 'is-invalid' : '' }}" type="number" name="product_price" id="product_price" value="{{ old('product_price', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purchase_discount') ? 'is-invalid' : '' }}" type="number" name="purchase_discount" id="purchase_discount" value="{{ old('purchase_discount', '') }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('has_stock') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="has_stock" id="has_stock" value="1" {{ old('has_stock', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('local_stock') ? 'is-invalid' : '' }}" type="number" name="local_stock" id="local_stock" value="{{ old('local_stock', '') }}" step="1">
