    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.availabilities.update", [$availability->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('star_time') ? 'is-invalid' : '' }}" type="text" name="star_time" id="star_time" value="{{ old('star_time', $availability->star_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_time') ? 'is-invalid' : '' }}" type="text" name="end_time" id="end_time" value="{{ old('end_time', $availability->end_time) }}" required>
