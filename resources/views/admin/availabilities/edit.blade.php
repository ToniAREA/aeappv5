...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.availabilities.update", [$availability->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $availability->date) }}">
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weekday') ? 'is-invalid' : '' }}" type="text" name="weekday" id="weekday" value="{{ old('weekday', $availability->weekday) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text" name="start_time" id="start_time" value="{{ old('start_time', $availability->start_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('end_time') ? 'is-invalid' : '' }}" type="text" name="end_time" id="end_time" value="{{ old('end_time', $availability->end_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rate_multiplier') ? 'is-invalid' : '' }}" type="number" name="rate_multiplier" id="rate_multiplier" value="{{ old('rate_multiplier', $availability->rate_multiplier) }}" step="0.01" required>
