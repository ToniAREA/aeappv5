...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employee-holidays.update", [$employeeHoliday->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $employeeHoliday->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $employeeHoliday->end_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('days_taken') ? 'is-invalid' : '' }}" type="number" name="days_taken" id="days_taken" value="{{ old('days_taken', $employeeHoliday->days_taken) }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_completed') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_completed" id="is_completed" value="1" {{ $employeeHoliday->is_completed || old('is_completed', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $employeeHoliday->type) }}">
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" type="text" name="notes" id="notes" value="{{ old('notes', $employeeHoliday->notes) }}">
                @if($errors->has('notes'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('internalnotes') ? 'is-invalid' : '' }}" type="text" name="internalnotes" id="internalnotes" value="{{ old('internalnotes', $employeeHoliday->internalnotes) }}">
