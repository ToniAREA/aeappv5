        ...
        <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_online') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_online" id="is_online" value="1" {{ $contentPage->is_online || old('is_online', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_online">{{ trans('cruds.contentPage.fields.is_online') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('excerpt') ? 'is-invalid' : '' }}" name="excerpt" id="excerpt">{!! old('excerpt', $contentPage->excerpt) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_title') ? 'is-invalid' : '' }}" type="text" name="seo_title" id="seo_title" value="{{ old('seo_title', $contentPage->seo_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_meta_description') ? 'is-invalid' : '' }}" type="text" name="seo_meta_description" id="seo_meta_description" value="{{ old('seo_meta_description', $contentPage->seo_meta_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_slug') ? 'is-invalid' : '' }}" type="text" name="seo_slug" id="seo_slug" value="{{ old('seo_slug', $contentPage->seo_slug) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_a') ? 'is-invalid' : '' }}" type="text" name="link_a" id="link_a" value="{{ old('link_a', $contentPage->link_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_a_description') ? 'is-invalid' : '' }}" type="text" name="link_a_description" id="link_a_description" value="{{ old('link_a_description', $contentPage->link_a_description) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show_online_link_a') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show_online_link_a" id="show_online_link_a" value="1" {{ $contentPage->show_online_link_a || old('show_online_link_a', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_b') ? 'is-invalid' : '' }}" type="text" name="link_b" id="link_b" value="{{ old('link_b', $contentPage->link_b) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_b_description') ? 'is-invalid' : '' }}" type="text" name="link_b_description" id="link_b_description" value="{{ old('link_b_description', $contentPage->link_b_description) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show_online_link_b') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show_online_link_b" id="show_online_link_b" value="1" {{ $contentPage->show_online_link_b || old('show_online_link_b', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('view_count') ? 'is-invalid' : '' }}" type="number" name="view_count" id="view_count" value="{{ old('view_count', $contentPage->view_count) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('authorized_roles') ? 'is-invalid' : '' }}" name="authorized_roles[]" id="authorized_roles" multiple>
                    @foreach($authorized_roles as $id => $authorized_role)
                        <option value="{{ $id }}" {{ (in_array($id, old('authorized_roles', [])) || $contentPage->authorized_roles->contains($id)) ? 'selected' : '' }}>{{ $authorized_role }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('authorized_users') ? 'is-invalid' : '' }}" name="authorized_users[]" id="authorized_users" multiple>
                    @foreach($authorized_users as $id => $authorized_user)
                        <option value="{{ $id }}" {{ (in_array($id, old('authorized_users', [])) || $contentPage->authorized_users->contains($id)) ? 'selected' : '' }}>{{ $authorized_user }}</option>
                    @endforeach
                </select>
