    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-wlistsProformas">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($proformas as $key => $proforma)
                            <tr data-entry-id="{{ $proforma->id }}">
                                ...
                                <td>
                                    @can('proforma_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.proformas.show', $proforma->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

                                    @can('proforma_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.proformas.edit', $proforma->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('proforma_delete')
                                        <form action="{{ route('admin.proformas.destroy', $proforma->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-wlistsProformas:not(.ajaxTable)').DataTable({ buttons: dtButtons })
