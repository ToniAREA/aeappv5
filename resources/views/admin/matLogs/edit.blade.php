...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.mat-logs.update", [$matLog->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $matLog->date) }}" required>
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item') ? 'is-invalid' : '' }}" type="text" name="item" id="item" value="{{ old('item', $matLog->item) }}">
                @if($errors->has('item'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $matLog->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pvp') ? 'is-invalid' : '' }}" type="number" name="pvp" id="pvp" value="{{ old('pvp', $matLog->pvp) }}" step="0.01">
                @if($errors->has('pvp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('units') ? 'is-invalid' : '' }}" type="number" name="units" id="units" value="{{ old('units', $matLog->units) }}" step="0.01">
                @if($errors->has('units'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('invoiced_line') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="invoiced_line" id="invoiced_line" value="1" {{ $matLog->invoiced_line || old('invoiced_line', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $matLog->status) }}">
