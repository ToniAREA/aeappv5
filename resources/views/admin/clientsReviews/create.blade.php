    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients-reviews.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="number" name="rating" id="rating" value="{{ old('rating', '') }}" step="0.1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('shown_online') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="shown_online" id="shown_online" value="1" {{ old('shown_online', 0) == 1 ? 'checked' : '' }}>
