        ...
        <form method="POST" action="{{ route("admin.clients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('has_active_maintenance_plan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="has_active_maintenance_plan" id="has_active_maintenance_plan" value="1" {{ old('has_active_maintenance_plan', 0) == 1 ? 'checked' : '' }}>
