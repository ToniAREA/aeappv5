...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.finantial-document-taxes.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\FinantialDocumentTax::TAX_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('tax_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="tax_type_{{ $key }}" name="tax_type" value="{{ $key }}" {{ old('tax_type', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_rate') ? 'is-invalid' : '' }}" type="number" name="tax_rate" id="tax_rate" value="{{ old('tax_rate', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_amount') ? 'is-invalid' : '' }}" type="number" name="tax_amount" id="tax_amount" value="{{ old('tax_amount', '') }}" step="0.01">
