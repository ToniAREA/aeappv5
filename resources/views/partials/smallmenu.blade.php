...
<div class="card m-0" style="padding: 2px;">
    <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; padding: 0;">


        <a href="{{ route('frontend.home') }}"
            class="btn btn-primary {{ request()->is('frontend/home') ? 'active' : '' }}"
            title="{{ trans('global.home') }}"
            style="flex: 1; margin: 0 2px; display: flex; justify-content: center; align-items: center;">
        ...
        @can('client_access')
            <a href="{{ route('frontend.clients.index') }}"
                ...
                title="{{ trans('cruds.client.title') }}"
                style="flex: 1; margin: 0 2px; display: flex; justify-content: center; align-items: center;">
        ...
        @can('marina_access')
            <a href="{{ route('frontend.marinas.index') }}"
                ...
                title="{{ trans('cruds.marina.title') }}"
                style="flex: 1; margin: 0 2px; display: flex; justify-content: center; align-items: center;">
