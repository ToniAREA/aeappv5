        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.skills-categories.update', [$skillsCategory->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="subject" id="subject"
                                    value="{{ old('subject', $skillsCategory->subject) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description" id="description"
                                    value="{{ old('description', $skillsCategory->description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.skillsCategory.fields.description_helper') }}</span>
                            </div>
                            <div class="form-group">
