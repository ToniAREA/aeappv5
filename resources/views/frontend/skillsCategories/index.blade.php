                                    ...
                                    <tr data-entry-id="{{ $skillsCategory->id }}">
                                        ...
                                        <td>
                                            @can('skills_category_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.skills-categories.show', $skillsCategory->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('skills_category_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.skills-categories.edit', $skillsCategory->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('skills_category_delete')
                                                <form action="{{ route('frontend.skills-categories.destroy', $skillsCategory->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
