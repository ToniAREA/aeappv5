            ...
            <div class="col-md-12">
                @can('skills_category_create')
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-success" href="{{ route('frontend.skills-categories.create') }}">
                            ...
                            @include('csvImport.modal', [
                                ...
                                'route' => 'admin.skills-categories.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-SkillsCategory">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('skills_category_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.skills-categories.show', $skillsCategory->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('skills_category_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.skills-categories.edit', $skillsCategory->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('skills_category_delete')
                                                    <form
                                                        action="{{ route('frontend.skills-categories.destroy', $skillsCategory->id) }}"
                                                        method="POST"
        ...
        $(function() {
            ...
            @can('skills_category_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('frontend.skills-categories.massDestroy') }}",
            ...
            let table = $('.datatable-SkillsCategory:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
