        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.employees-ratings.update', [$employeesRating->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="employee_id" id="employee_id">
                                    @foreach ($employees as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('employee_id') ? old('employee_id') : $employeesRating->employee->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="from_user_id" id="from_user_id">
                                    @foreach ($from_users as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('from_user_id') ? old('from_user_id') : $employeesRating->from_user->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.employeesRating.fields.from_user_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="from_client_id" id="from_client_id">
                                    @foreach ($from_clients as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('from_client_id') ? old('from_client_id') : $employeesRating->from_client->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.employeesRating.fields.from_client_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="for_wlist_id" id="for_wlist_id">
                                    @foreach ($for_wlists as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('for_wlist_id') ? old('for_wlist_id') : $employeesRating->for_wlist->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.employeesRating.fields.for_wlist_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="for_wlog_id" id="for_wlog_id">
                                    @foreach ($for_wlogs as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('for_wlog_id') ? old('for_wlog_id') : $employeesRating->for_wlog->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="rating" id="rating"
                                    value="{{ old('rating', $employeesRating->rating) }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="comment" id="comment"
                                    value="{{ old('comment', $employeesRating->comment) }}">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="show_online" id="show_online" value="1"
                                        {{ $employeesRating->show_online || old('show_online', 0) === 1 ? 'checked' : '' }}>
                                    <label
                                        for="show_online">{{ trans('cruds.employeesRating.fields.show_online') }}</label>
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.employeesRating.fields.show_online_helper') }}</span>
                            </div>
                            <div class="form-group">
