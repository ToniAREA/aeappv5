            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        {{ trans('global.create') }} {{ trans('cruds.employeesRating.title_singular') }}
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.employees-ratings.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="from_user_id" id="from_user_id">
                                    @foreach ($from_users as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('from_user_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="from_client_id" id="from_client_id">
                                    @foreach ($from_clients as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('from_client_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="for_wlist_id" id="for_wlist_id">
                                    @foreach ($for_wlists as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('for_wlist_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="for_wlog_id" id="for_wlog_id">
                                    @foreach ($for_wlogs as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('for_wlog_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                    @endforeach
                                </select>
