        ...
        <div class="col-md-12">
            @can('employees_rating_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.employees-ratings.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $employeesRating->id }}">
                                        ...
                                        <td>
                                            @can('employees_rating_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.employees-ratings.show', $employeesRating->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('employees_rating_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.employees-ratings.edit', $employeesRating->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('employees_rating_delete')
                                                <form action="{{ route('frontend.employees-ratings.destroy', $employeesRating->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('employees_rating_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.employees-ratings.massDestroy') }}",
