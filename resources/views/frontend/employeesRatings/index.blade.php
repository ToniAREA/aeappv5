                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-EmployeesRating">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('employees_rating_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.employees-ratings.show', $employeesRating->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('employees_rating_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.employees-ratings.edit', $employeesRating->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('employees_rating_delete')
                                                    <form
                                                        action="{{ route('frontend.employees-ratings.destroy', $employeesRating->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-EmployeesRating:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
