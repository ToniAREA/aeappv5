                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                ...
                                'route' => 'admin.contact-contacts.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-ContactContact">
                                <thead>
                                    <tr>
                                        <th>
                                        ...
                                        <tr data-entry-id="{{ $contactContact->id }}">
                                            ...
                                            <td>
                                                @if ($contactContact->photo)
                                                    <a href="{{ $contactContact->photo->getUrl() }}" target="_blank"
                                            ...
                                            <td>
                                                @can('contact_contact_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.contact-contacts.show', $contactContact->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('contact_contact_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.contact-contacts.edit', $contactContact->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('contact_contact_delete')
                                                    <form
                                                        action="{{ route('frontend.contact-contacts.destroy', $contactContact->id) }}"
                                                        method="POST"
