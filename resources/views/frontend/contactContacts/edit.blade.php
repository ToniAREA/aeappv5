    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contact-contacts.update", [$contactContact->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_nif" id="contact_nif" value="{{ old('contact_nif', $contactContact->contact_nif) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_country" id="contact_country" value="{{ old('contact_country', $contactContact->contact_country) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_mobile" id="contact_mobile" value="{{ old('contact_mobile', $contactContact->contact_mobile) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_mobile_2" id="contact_mobile_2" value="{{ old('contact_mobile_2', $contactContact->contact_mobile_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_email_2" id="contact_email_2" value="{{ old('contact_email_2', $contactContact->contact_email_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="social_link" id="social_link" value="{{ old('social_link', $contactContact->social_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_tags" id="contact_tags" value="{{ old('contact_tags', $contactContact->contact_tags) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_notes" id="contact_notes" value="{{ old('contact_notes', $contactContact->contact_notes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_internalnotes" id="contact_internalnotes" value="{{ old('contact_internalnotes', $contactContact->contact_internalnotes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $contactContact->link) }}">
                            @if($errors->has('link'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('link') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_description" id="link_description" value="{{ old('link_description', $contactContact->link_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="last_use" id="last_use" value="{{ old('last_use', $contactContact->last_use) }}">
