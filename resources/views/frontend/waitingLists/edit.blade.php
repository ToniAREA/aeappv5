                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.waiting-lists.update", [$waitingList->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="waiting_for" id="waiting_for" value="{{ old('waiting_for', $waitingList->waiting_for) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="notes" id="notes" value="{{ old('notes', $waitingList->notes) }}">
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
