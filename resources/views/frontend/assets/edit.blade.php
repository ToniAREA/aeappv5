        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.assets.update', [$asset->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_available" id="is_available" value="1"
                                        {{ $asset->is_available || old('is_available', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="category_id" id="category_id" required>
                                    @foreach ($categories as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('category_id') ? old('category_id') : $asset->category->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status_id" id="status_id" required>
                                    @foreach ($statuses as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('status_id') ? old('status_id') : $asset->status->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="location_id" id="location_id" required>
                                    @foreach ($locations as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('location_id') ? old('location_id') : $asset->location->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="actual_holder_id" id="actual_holder_id">
                                    @foreach ($actual_holders as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('actual_holder_id') ? old('actual_holder_id') : $asset->actual_holder->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internal_notes" id="internal_notes"
                                    value="{{ old('internal_notes', $asset->internal_notes) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="data_1" id="data_1"
                                    value="{{ old('data_1', $asset->data_1) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="data_1_description">{{ trans('cruds.asset.fields.data_1_description') }}</label>
                                <input class="form-control" type="text" name="data_1_description"
                                    id="data_1_description"
                                    value="{{ old('data_1_description', $asset->data_1_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.asset.fields.data_1_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label for="data_2">{{ trans('cruds.asset.fields.data_2') }}</label>
                                <input class="form-control" type="text" name="data_2" id="data_2"
                                    value="{{ old('data_2', $asset->data_2) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="data_2_description">{{ trans('cruds.asset.fields.data_2_description') }}</label>
                                <input class="form-control" type="text" name="data_2_description"
                                    id="data_2_description"
                                    value="{{ old('data_2_description', $asset->data_2_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.asset.fields.data_2_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_a_description">{{ trans('cruds.asset.fields.link_a_description') }}</label>
                                <input class="form-control" type="text" name="link_a_description"
                                    id="link_a_description"
                                    value="{{ old('link_a_description', $asset->link_a_description) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_b_description">{{ trans('cruds.asset.fields.link_b_description') }}</label>
                                <input class="form-control" type="text" name="link_b_description"
                                    id="link_b_description"
                                    value="{{ old('link_b_description', $asset->link_b_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.asset.fields.link_b_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="last_use" id="last_use"
                                    value="{{ old('last_use', $asset->last_use) }}">
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('frontend.assets.storeCKEditorImages') }}',
                                            true);
