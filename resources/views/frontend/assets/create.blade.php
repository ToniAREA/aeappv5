                        ...
                        <form method="POST" action="{{ route('frontend.assets.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="category_id" id="category_id" required>
                                    @foreach ($categories as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('category_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status_id" id="status_id" required>
                                    @foreach ($statuses as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('status_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="location_id" id="location_id" required>
                                    @foreach ($locations as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('location_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="actual_holder_id" id="actual_holder_id">
                                    @foreach ($actual_holders as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('actual_holder_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="data_1_description"
                                    id="data_1_description" value="{{ old('data_1_description', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="data_2_description"
                                    id="data_2_description" value="{{ old('data_2_description', '') }}">
