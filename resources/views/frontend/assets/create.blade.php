                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assets.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="data_1" id="data_1" value="{{ old('data_1', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="data_1_description" id="data_1_description" value="{{ old('data_1_description', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="data_2" id="data_2" value="{{ old('data_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="data_2_description" id="data_2_description" value="{{ old('data_2_description', '') }}">
