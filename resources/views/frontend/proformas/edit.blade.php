        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.proformas.update', [$proforma->id]) }}"
                            enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label class="required"
                                    for="proforma_number">{{ trans('cruds.proforma.fields.proforma_number') }}</label>
                                <input class="form-control" type="text" name="proforma_number" id="proforma_number"
                                    value="{{ old('proforma_number', $proforma->proforma_number) }}" required>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="closed_and_protected" id="closed_and_protected"
                                        value="1"
                                        {{ $proforma->closed_and_protected || old('closed_and_protected', 0) === 1 ? 'checked' : '' }}>
                                    <label
                                        for="closed_and_protected">{{ trans('cruds.proforma.fields.closed_and_protected') }}</label>
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.proforma.fields.closed_and_protected_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label for="invoice_link">{{ trans('cruds.proforma.fields.invoice_link') }}</label>
                                <input class="form-control" type="text" name="invoice_link" id="invoice_link"
                                    value="{{ old('invoice_link', $proforma->invoice_link) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="client_id" id="client_id">
                                    @foreach ($clients as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('client_id') ? old('client_id') : $proforma->client->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boats[]" id="boats" multiple>
                                    @foreach ($boats as $id => $boat)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('boats', [])) || $proforma->boats->contains($id) ? 'selected' : '' }}>
                                            {{ $boat }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('boats'))
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="wlists[]" id="wlists" multiple>
                                    @foreach ($wlists as $id => $wlist)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('wlists', [])) || $proforma->wlists->contains($id) ? 'selected' : '' }}>
                                            {{ $wlist }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description" id="description"
                                    value="{{ old('description', $proforma->description) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="total_amount" id="total_amount"
                                    value="{{ old('total_amount', $proforma->total_amount) }}" step="0.01">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="currency" id="currency"
                                    value="{{ old('currency', $proforma->currency) }}">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="sent" id="sent" value="1"
                                        {{ $proforma->sent || old('sent', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="paid" id="paid" value="1"
                                        {{ $proforma->paid || old('paid', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="claims" id="claims"
                                    value="{{ old('claims', $proforma->claims) }}" step="1">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_description">{{ trans('cruds.proforma.fields.link_description') }}</label>
                                <input class="form-control" type="text" name="link_description" id="link_description"
                                    value="{{ old('link_description', $proforma->link_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.proforma.fields.link_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label for="status">{{ trans('cruds.proforma.fields.status') }}</label>
                                <input class="form-control" type="text" name="status" id="status"
                                    value="{{ old('status', $proforma->status) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="notes" id="notes"
                                    value="{{ old('notes', $proforma->notes) }}">
                                @if ($errors->has('notes'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('notes') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internal_notes" id="internal_notes"
                                    value="{{ old('internal_notes', $proforma->internal_notes) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="completed_at"
                                    id="completed_at" value="{{ old('completed_at', $proforma->completed_at) }}">
