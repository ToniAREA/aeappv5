                            ...
                            <tbody>
                                @foreach($iotDevices as $key => $iotDevice)
                                    <tr data-entry-id="{{ $iotDevice->id }}">
                                        ...
                                        <td>
                                            @can('iot_device_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.iot-devices.show', $iotDevice->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('iot_device_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.iot-devices.edit', $iotDevice->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('iot_device_delete')
                                                <form action="{{ route('frontend.iot-devices.destroy', $iotDevice->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('iot_device_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.iot-devices.massDestroy') }}",
