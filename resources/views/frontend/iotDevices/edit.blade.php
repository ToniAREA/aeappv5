    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.iot-devices.update", [$iotDevice->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <div>
                                <input type="hidden" name="is_active" value="0">
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $iotDevice->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $iotDevice->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="device" id="device" value="{{ old('device', $iotDevice->device) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="security_token" id="security_token" value="{{ old('security_token', $iotDevice->security_token) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="serial_number" id="serial_number" value="{{ old('serial_number', $iotDevice->serial_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\IotDevice::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $iotDevice->status) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="additional_info" id="additional_info">{{ old('additional_info', $iotDevice->additional_info) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="source_code_link" id="source_code_link" value="{{ old('source_code_link', $iotDevice->source_code_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="notes" id="notes" value="{{ old('notes', $iotDevice->notes) }}">
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="internal_notes" id="internal_notes" value="{{ old('internal_notes', $iotDevice->internal_notes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $iotDevice->link) }}">
                            @if($errors->has('link'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('link') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_name" id="link_name" value="{{ old('link_name', $iotDevice->link_name) }}">
