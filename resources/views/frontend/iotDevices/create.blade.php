                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.iot-devices.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="device" id="device" value="{{ old('device', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\IotDevice::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', 'available') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="source_code_link" id="source_code_link" value="{{ old('source_code_link', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_name" id="link_name" value="{{ old('link_name', '') }}">
