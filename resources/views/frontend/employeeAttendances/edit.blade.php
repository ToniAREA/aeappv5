    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.employee-attendances.update", [$employeeAttendance->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $employeeAttendance->date) }}" required>
                            @if($errors->has('date'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('date') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="arrival_time" id="arrival_time" value="{{ old('arrival_time', $employeeAttendance->arrival_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="departure_time" id="departure_time" value="{{ old('departure_time', $employeeAttendance->departure_time) }}">
