        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.to-dos.update', [$toDo->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="for_roles[]" id="for_roles" multiple>
                                    @foreach ($for_roles as $id => $for_role)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('for_roles', [])) || $toDo->for_roles->contains($id) ? 'selected' : '' }}>
                                            {{ $for_role }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="for_employee_id" id="for_employee_id">
                                    @foreach ($for_employees as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('for_employee_id') ? old('for_employee_id') : $toDo->for_employee->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="priority" id="priority"
                                    value="{{ old('priority', $toDo->priority) }}" step="1">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_repetitive" id="is_repetitive" value="1"
                                        {{ $toDo->is_repetitive || old('is_repetitive', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="repeat_interval_value"
                                    ...
                                    value="{{ old('repeat_interval_value', $toDo->repeat_interval_value) }}"
                                    step="1">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="repeat_interval_unit" id="repeat_interval_unit">
                                    ...
                                    @foreach (App\Models\ToDo::REPEAT_INTERVAL_UNIT_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('repeat_interval_unit', $toDo->repeat_interval_unit) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internal_notes" id="internal_notes"
                                    value="{{ old('internal_notes', $toDo->internal_notes) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="completed_at"
                                    id="completed_at" value="{{ old('completed_at', $toDo->completed_at) }}">
