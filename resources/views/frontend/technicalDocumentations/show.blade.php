                            ...
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($technicalDocumentation->image)
                                                <a href="{{ $technicalDocumentation->image->getUrl() }}" target="_blank"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($technicalDocumentation->authorized_roles as $key => $authorized_roles)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($technicalDocumentation->authorized_users as $key => $authorized_users)
