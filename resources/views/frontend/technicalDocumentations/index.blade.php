                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                ...
                                'route' => 'admin.technical-documentations.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-TechnicalDocumentation">
                                <thead>
                                    <tr>
                                        <th>
                                ...
                                <tbody>
                                    @foreach ($technicalDocumentations as $key => $technicalDocumentation)
                                        <tr data-entry-id="{{ $technicalDocumentation->id }}">
                                            ...
                                            <td>
                                                <span
                                                    style="display:none">{{ $technicalDocumentation->is_online ?? '' }}</span>
                                                <input type="checkbox" disabled="disabled"
                                                    {{ $technicalDocumentation->is_online ? 'checked' : '' }}>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if ($technicalDocumentation->file)
                                                    <a href="{{ $technicalDocumentation->file->getUrl() }}"
                                                        target="_blank">
                                            ...
                                            <td>
                                                @if ($technicalDocumentation->image)
                                                    <a href="{{ $technicalDocumentation->image->getUrl() }}"
                                            ...
                                            <td>
                                                @can('technical_documentation_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.technical-documentations.show', $technicalDocumentation->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('technical_documentation_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.technical-documentations.edit', $technicalDocumentation->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('technical_documentation_delete')
                                                    <form
                                                        action="{{ route('frontend.technical-documentations.destroy', $technicalDocumentation->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-TechnicalDocumentation:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
