                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('frontend.wlists.store') }}" enctype="multipart/form-data">
                            ...
                            <!-- Tab panes -->
                            <div class="tab-content" id="wlistTabContent">
                                <!-- First Tab -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            @foreach (App\Models\Wlist::ORDER_TYPE_RADIO as $key => $label)
                                                <label
                                                    class="btn btn-primary {{ old('order_type', 'request') === (string) $key ? 'active' : '' }}">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" name="estimated_hours"
                                                    id="estimated_hours" value="{{ old('estimated_hours', '') }}"
                                                    step="0.01">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" name="priority"
                                                    id="priority" value="{{ old('priority', '') }}" step="1">
                                ...
                                <div class="tab-pane fade" id="tab-details" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control datetime" type="text" name="last_use"
                                            id="last_use" value="{{ old('last_use') }}">
