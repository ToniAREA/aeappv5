                    ...
                    <form method="POST" action="{{ route("frontend.wlists.update", [$wlist->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Wlist::ORDER_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="order_type_{{ $key }}" name="order_type" value="{{ $key }}" {{ old('order_type', $wlist->order_type) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="estimated_hours" id="estimated_hours" value="{{ old('estimated_hours', $wlist->estimated_hours) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="priority" id="priority" value="{{ old('priority', $wlist->priority) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="proforma_link" id="proforma_link" value="{{ old('proforma_link', $wlist->proforma_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $wlist->link) }}">
                            @if($errors->has('link'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('link') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_description" id="link_description" value="{{ old('link_description', $wlist->link_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="last_use" id="last_use" value="{{ old('last_use', $wlist->last_use) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="completed_at" id="completed_at" value="{{ old('completed_at', $wlist->completed_at) }}">
