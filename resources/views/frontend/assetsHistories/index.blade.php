                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'AssetsHistory',
                                'route' => 'admin.assets-histories.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-AssetsHistory">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('assets_history_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.assets-histories.show', $assetsHistory->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('assets_history_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.assets-histories.edit', $assetsHistory->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('assets_history_delete')
                                                    <form
                                                        action="{{ route('frontend.assets-histories.destroy', $assetsHistory->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-AssetsHistory:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
