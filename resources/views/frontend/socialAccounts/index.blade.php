            ...
            <div class="col-md-12">
                @can('social_account_create')
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-success" href="{{ route('frontend.social-accounts.create') }}">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'SocialAccount',
                                'route' => 'admin.social-accounts.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-SocialAccount">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('social_account_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.social-accounts.show', $socialAccount->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('social_account_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.social-accounts.edit', $socialAccount->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('social_account_delete')
                                                    <form
                                                        action="{{ route('frontend.social-accounts.destroy', $socialAccount->id) }}"
                                                        method="POST"
        ...
        $(function() {
            ...
            @can('social_account_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('frontend.social-accounts.massDestroy') }}",
            ...
            let table = $('.datatable-SocialAccount:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
