                                    ...
                                    <tr data-entry-id="{{ $socialAccount->id }}">
                                        ...
                                        <td>
                                            @can('social_account_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.social-accounts.show', $socialAccount->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('social_account_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.social-accounts.edit', $socialAccount->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('social_account_delete')
                                                <form action="{{ route('frontend.social-accounts.destroy', $socialAccount->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
