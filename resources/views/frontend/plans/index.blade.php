                                            ...
                                            <td>
                                                @can('plan_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.plans.show', $plan->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('plan_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.plans.edit', $plan->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('plan_delete')
                                                    <form action="{{ route('frontend.plans.destroy', $plan->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Plan:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
