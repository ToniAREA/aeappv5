                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.plans.update", [$plan->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $plan->description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="duration_months" id="duration_months" value="{{ old('duration_months', $plan->duration_months) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $plan->price) }}" step="0.01">
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
