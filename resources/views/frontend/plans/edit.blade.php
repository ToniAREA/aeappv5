                    ...
                    <form method="POST" action="{{ route("frontend.plans.update", [$plan->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_online" id="is_online" value="1" {{ $plan->is_online || old('is_online', 0) === 1 ? 'checked' : '' }}>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.plans.storeCKEditorImages') }}', true);
