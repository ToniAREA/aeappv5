        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.clients.update', [$client->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="has_active_vip_plan" id="has_active_vip_plan"
                                        value="1"
                                        {{ $client->has_active_vip_plan || old('has_active_vip_plan', 0) === 1 ? 'checked' : '' }}>
                                    <label
                                        for="has_active_vip_plan">{{ trans('cruds.client.fields.has_active_vip_plan') }}</label>
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.client.fields.has_active_vip_plan_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <div>
                                    <input type="hidden" name="has_active_maintenance_plan" value="0">
                                    <input type="checkbox" name="has_active_maintenance_plan"
                                        id="has_active_maintenance_plan" value="1"
                                        {{ $client->has_active_maintenance_plan || old('has_active_maintenance_plan', 0) === 1 ? 'checked' : '' }}>
                                    <label
                                        for="has_active_maintenance_plan">{{ trans('cruds.client.fields.has_active_maintenance_plan') }}</label>
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.client.fields.has_active_maintenance_plan_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <div>
                                    <input type="hidden" name="defaulter" value="0">
                                    <input type="checkbox" name="defaulter" id="defaulter" value="1"
                                        {{ $client->defaulter || old('defaulter', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="contacts[]" id="contacts" multiple>
                                    @foreach ($contacts as $id => $contact)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('contacts', [])) || $client->contacts->contains($id) ? 'selected' : '' }}>
                                            {{ $contact }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boats[]" id="boats" multiple>
                                    @foreach ($boats as $id => $boat)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('boats', [])) || $client->boats->contains($id) ? 'selected' : '' }}>
                                            {{ $boat }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('boats'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internal_notes" id="internal_notes"
                                    value="{{ old('internal_notes', $client->internal_notes) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="coordinates" id="coordinates"
                                    value="{{ old('coordinates', $client->coordinates) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link_a" id="link_a"
                                    value="{{ old('link_a', $client->link_a) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_a_description">{{ trans('cruds.client.fields.link_a_description') }}</label>
                                <input class="form-control" type="text" name="link_a_description"
                                    id="link_a_description"
                                    value="{{ old('link_a_description', $client->link_a_description) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_b_description">{{ trans('cruds.client.fields.link_b_description') }}</label>
                                <input class="form-control" type="text" name="link_b_description"
                                    id="link_b_description"
                                    value="{{ old('link_b_description', $client->link_b_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.client.fields.link_b_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="last_use" id="last_use"
                                    value="{{ old('last_use', $client->last_use) }}">
