                    ...
                    <form method="POST" action="{{ route("frontend.clients.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_active_vip_plan" id="has_active_vip_plan" value="1" {{ old('has_active_vip_plan', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_active_maintenance_plan" id="has_active_maintenance_plan" value="1" {{ old('has_active_maintenance_plan', 0) == 1 ? 'checked' : '' }}>
