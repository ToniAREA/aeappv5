                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.comments.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="to_users[]" id="to_users" multiple>
                                @foreach($to_users as $id => $to_user)
                                    <option value="{{ $id }}" {{ in_array($id, old('to_users', [])) ? 'selected' : '' }}>{{ $to_user }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="private_comment" id="private_comment" value="{{ old('private_comment', '') }}">
