                                        ...
                                        <td>
                                            <select class="search">
                                                ...
                                                @foreach ($wlists as $key => $item)
                                                    <option value="{{ $item->boat_namecomplete }}">
                                                        {{ $item->boat_namecomplete }}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td>
                                            ...
                                            <td>
                                                @can('comment_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.comments.show', $comment->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('comment_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.comments.edit', $comment->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('comment_delete')
                                                    <form action="{{ route('frontend.comments.destroy', $comment->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Comment:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
