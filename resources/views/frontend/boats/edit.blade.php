                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.boats.update", [$boat->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="boat_type" id="boat_type" value="{{ old('boat_type', $boat->boat_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="imo" id="imo" value="{{ old('imo', $boat->imo) }}">
                            @if($errors->has('imo'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('imo') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mmsi" id="mmsi" value="{{ old('mmsi', $boat->mmsi) }}">
                            @if($errors->has('mmsi'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('mmsi') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sat_phone" id="sat_phone" value="{{ old('sat_phone', $boat->sat_phone) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_description" id="link_description" value="{{ old('link_description', $boat->link_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="last_use" id="last_use" value="{{ old('last_use', $boat->last_use) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="settings_data" id="settings_data">{{ old('settings_data', $boat->settings_data) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="public_ip" id="public_ip" value="{{ old('public_ip', $boat->public_ip) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="coordinates" id="coordinates" value="{{ old('coordinates', $boat->coordinates) }}">
