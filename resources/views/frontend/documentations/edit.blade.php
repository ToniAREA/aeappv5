            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        {{ trans('global.edit') }} {{ trans('cruds.documentation.title_singular') }}
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.documentations.update', [$documentation->id]) }}"
                            enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label class="required"
                                    for="name">{{ trans('cruds.documentation.fields.name') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="category_id" id="category_id">
                                    @foreach ($categories as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('category_id') ? old('category_id') : $documentation->category->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="expiration_date">{{ trans('cruds.documentation.fields.expiration_date') }}</label>
                                <input class="form-control date" type="text" name="expiration_date" id="expiration_date"
                                    value="{{ old('expiration_date', $documentation->expiration_date) }}" required>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.documentation.fields.expiration_date_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <div>
                                    <input type="hidden" name="is_valid" value="0">
                                    <input type="checkbox" name="is_valid" id="is_valid" value="1"
                                        {{ $documentation->is_valid || old('is_valid', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="file">{{ trans('cruds.documentation.fields.file') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="notes" id="notes"
                                    value="{{ old('notes', $documentation->notes) }}">
                                @if ($errors->has('notes'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('notes') }}
                                    </div>
                            ...
                            <div class="form-group">
                                <label
                                    for="internal_notes">{{ trans('cruds.documentation.fields.internal_notes') }}</label>
                                <input class="form-control" type="text" name="internal_notes" id="internal_notes"
                                    value="{{ old('internal_notes', $documentation->internal_notes) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.documentation.fields.internal_notes_helper') }}</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_description">{{ trans('cruds.documentation.fields.link_description') }}</label>
                                <input class="form-control" type="text" name="link_description" id="link_description"
                                    value="{{ old('link_description', $documentation->link_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.documentation.fields.link_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label
                                    for="authorized_roles">{{ trans('cruds.documentation.fields.authorized_roles') }}</label>
                                ...
                                <select class="form-control select2" name="authorized_roles[]" id="authorized_roles"
                                    ...
                                    @foreach ($authorized_roles as $id => $authorized_role)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('authorized_roles', [])) || $documentation->authorized_roles->contains($id) ? 'selected' : '' }}>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.documentation.fields.authorized_roles_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label
                                    for="authorized_users">{{ trans('cruds.documentation.fields.authorized_users') }}</label>
                                <div style="padding-bottom: 4px">
                                    <span class="btn btn-info btn-xs select-all"
                                        style="border-radius: 0">{{ trans('global.select_all') }}</span>
                                    <span class="btn btn-info btn-xs deselect-all"
                                ...
                                <select class="form-control select2" name="authorized_users[]" id="authorized_users"
                                    ...
                                    @foreach ($authorized_users as $id => $authorized_user)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('authorized_users', [])) || $documentation->authorized_users->contains($id) ? 'selected' : '' }}>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.documentation.fields.authorized_users_helper') }}</span>
                            </div>
                            <div class="form-group">
