                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'Documentation',
                                'route' => 'admin.documentations.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-Documentation">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('documentation_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.documentations.show', $documentation->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('documentation_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.documentations.edit', $documentation->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('documentation_delete')
                                                    <form
                                                        action="{{ route('frontend.documentations.destroy', $documentation->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Documentation:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
