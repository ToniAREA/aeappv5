                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'Currency',
                                'route' => 'admin.currencies.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                            ...
                                            <td>
                                                @can('currency_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.currencies.show', $currency->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('currency_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.currencies.edit', $currency->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('currency_delete')
                                                    <form action="{{ route('frontend.currencies.destroy', $currency->id) }}"
                                                        method="POST"
