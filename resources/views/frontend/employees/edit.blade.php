                    ...
                    <form method="POST" action="{{ route("frontend.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $employee->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_employee" id="id_employee" value="{{ old('id_employee', $employee->id_employee) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="namecomplete" id="namecomplete" value="{{ old('namecomplete', $employee->namecomplete) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $employee->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="contract_starts" id="contract_starts" value="{{ old('contract_starts', $employee->contract_starts) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="contract_ends" id="contract_ends" value="{{ old('contract_ends', $employee->contract_ends) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="internalnotes" id="internalnotes" value="{{ old('internalnotes', $employee->internalnotes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $employee->link) }}">
                            @if($errors->has('link'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('link') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_description" id="link_description" value="{{ old('link_description', $employee->link_description) }}">
