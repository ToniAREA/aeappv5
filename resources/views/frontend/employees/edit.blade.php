        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.employees.update', [$employee->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_active" id="is_active" value="1"
                                        {{ $employee->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="id_employee" id="id_employee"
                                    value="{{ old('id_employee', $employee->id_employee) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="namecomplete" id="namecomplete"
                                    value="{{ old('namecomplete', $employee->namecomplete) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="user_id" id="user_id">
                                    @foreach ($users as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('user_id') ? old('user_id') : $employee->user->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('user'))
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="contact_id" id="contact_id">
                                    @foreach ($contacts as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('contact_id') ? old('contact_id') : $employee->contact->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" type="text" name="contract_starts" id="contract_starts"
                                    value="{{ old('contract_starts', $employee->contract_starts) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" type="text" name="contract_ends" id="contract_ends"
                                    value="{{ old('contract_ends', $employee->contract_ends) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internalnotes" id="internalnotes"
                                    value="{{ old('internalnotes', $employee->internalnotes) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_description">{{ trans('cruds.employee.fields.link_description') }}</label>
                                <input class="form-control" type="text" name="link_description" id="link_description"
                                    value="{{ old('link_description', $employee->link_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.employee.fields.link_description_helper') }}</span>
                            </div>
                            <div class="form-group">
