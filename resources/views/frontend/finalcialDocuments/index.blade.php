            ...
            <div class="col-md-12">
                @can('finalcial_document_create')
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-success" href="{{ route('frontend.finalcial-documents.create') }}">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'FinalcialDocument',
                                'route' => 'admin.finalcial-documents.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-FinalcialDocument">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('finalcial_document_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.finalcial-documents.show', $finalcialDocument->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('finalcial_document_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.finalcial-documents.edit', $finalcialDocument->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('finalcial_document_delete')
                                                    <form
                                                        action="{{ route('frontend.finalcial-documents.destroy', $finalcialDocument->id) }}"
                                                        method="POST"
        ...
        $(function() {
            ...
            @can('finalcial_document_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('frontend.finalcial-documents.massDestroy') }}",
            ...
            let table = $('.datatable-FinalcialDocument:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
