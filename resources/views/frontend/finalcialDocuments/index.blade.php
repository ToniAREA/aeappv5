                                    ...
                                    <tr data-entry-id="{{ $finalcialDocument->id }}">
                                        ...
                                        <td>
                                            @can('finalcial_document_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.finalcial-documents.show', $finalcialDocument->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('finalcial_document_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.finalcial-documents.edit', $finalcialDocument->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('finalcial_document_delete')
                                                <form action="{{ route('frontend.finalcial-documents.destroy', $finalcialDocument->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
