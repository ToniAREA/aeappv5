    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.finalcial-documents.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            ...
                            @foreach(App\Models\FinalcialDocument::DOC_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="doc_type_{{ $key }}" name="doc_type" value="{{ $key }}" {{ old('doc_type', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="subtotal" id="subtotal" value="{{ old('subtotal', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_taxes" id="total_taxes" value="{{ old('total_taxes', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_discounts" id="total_discounts" value="{{ old('total_discounts', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="security_code" id="security_code" value="{{ old('security_code', '') }}">
