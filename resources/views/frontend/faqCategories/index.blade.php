                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'FaqCategory',
                                'route' => 'admin.faq-categories.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                        ...
                                        <tr data-entry-id="{{ $faqCategory->id }}">
                                            ...
                                            <td>
                                                @if ($faqCategory->photo)
                                                    <a href="{{ $faqCategory->photo->getUrl() }}" target="_blank"
                                            ...
                                            <td>
                                                @can('faq_category_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.faq-categories.show', $faqCategory->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('faq_category_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.faq-categories.edit', $faqCategory->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('faq_category_delete')
                                                    <form
                                                        action="{{ route('frontend.faq-categories.destroy', $faqCategory->id) }}"
                                                        method="POST"
