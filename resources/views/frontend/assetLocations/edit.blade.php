        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.asset-locations.update', [$assetLocation->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_available" id="is_available" value="1"
                                        {{ $assetLocation->is_available || old('is_available', 0) === 1 ? 'checked' : '' }}>
                                    <label for="is_available">{{ trans('cruds.assetLocation.fields.is_available') }}</label>
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.assetLocation.fields.is_available_helper') }}</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description" id="description"
                                    value="{{ old('description', $assetLocation->description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.assetLocation.fields.description_helper') }}</span>
                            </div>
                            <div class="form-group">
...
@section('scripts')
    <script>
        Dropzone.options.photoDropzone = {
            url: '{{ route('frontend.asset-locations.storeMedia') }}',
            maxFilesize: 5, // MB
