        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST"
                            action="{{ route('frontend.checkpoints-groups.update', [$checkpointsGroup->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_available" id="is_available" value="1"
                                        {{ $checkpointsGroup->is_available || old('is_available', 0) === 1 ? 'checked' : '' }}>
                                    <label
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="group" id="group"
                                    value="{{ old('group', $checkpointsGroup->group) }}" required>
                                @if ($errors->has('group'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('group') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description" id="description"
                                    value="{{ old('description', $checkpointsGroup->description) }}">
