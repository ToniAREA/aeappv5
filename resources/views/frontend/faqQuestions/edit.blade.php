        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.faq-questions.update', [$faqQuestion->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_online" id="is_online" value="1"
                                        {{ $faqQuestion->is_online || old('is_online', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="category_id">{{ trans('cruds.faqQuestion.fields.category') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="answer" id="answer">{!! old('answer', $faqQuestion->answer) !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="view_count" id="view_count"
                                    value="{{ old('view_count', $faqQuestion->view_count) }}" step="1">
                            ...
                            <div class="form-group">
                                <label
                                    for="authorized_roles">{{ trans('cruds.faqQuestion.fields.authorized_roles') }}</label>
                                ...
                                <select class="form-control select2" name="authorized_roles[]" id="authorized_roles"
                                    ...
                                    @foreach ($authorized_roles as $id => $authorized_role)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('authorized_roles', [])) || $faqQuestion->authorized_roles->contains($id) ? 'selected' : '' }}>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.faqQuestion.fields.authorized_roles_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label
                                    for="authorized_users">{{ trans('cruds.faqQuestion.fields.authorized_users') }}</label>
                                <div style="padding-bottom: 4px">
                                    <span class="btn btn-info btn-xs select-all"
                                        style="border-radius: 0">{{ trans('global.select_all') }}</span>
                                    <span class="btn btn-info btn-xs deselect-all"
                                ...
                                <select class="form-control select2" name="authorized_users[]" id="authorized_users"
                                    ...
                                    @foreach ($authorized_users as $id => $authorized_user)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('authorized_users', [])) || $faqQuestion->authorized_users->contains($id) ? 'selected' : '' }}>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.faqQuestion.fields.authorized_users_helper') }}</span>
                            </div>
                            <div class="form-group">
...
@section('scripts')
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('frontend.faq-questions.storeCKEditorImages') }}',
                                            true);
    ...
    <script>
        Dropzone.options.photoDropzone = {
            url: '{{ route('frontend.faq-questions.storeMedia') }}',
            maxFilesize: 5, // MB
