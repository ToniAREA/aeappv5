                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'FaqQuestion',
                                'route' => 'admin.faq-questions.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                        ...
                                        <tr data-entry-id="{{ $faqQuestion->id }}">
                                            ...
                                            <td>
                                                @if ($faqQuestion->photo)
                                                    <a href="{{ $faqQuestion->photo->getUrl() }}" target="_blank"
                                            ...
                                            <td>
                                                @can('faq_question_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.faq-questions.show', $faqQuestion->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('faq_question_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.faq-questions.edit', $faqQuestion->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('faq_question_delete')
                                                    <form
                                                        action="{{ route('frontend.faq-questions.destroy', $faqQuestion->id) }}"
                                                        method="POST"
