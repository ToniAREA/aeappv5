                                    ...
                                    <tr data-entry-id="{{ $employeeRating->id }}">
                                        ...
                                        <td>
                                            @can('employee_rating_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.employee-ratings.show', $employeeRating->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('employee_rating_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.employee-ratings.edit', $employeeRating->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('employee_rating_delete')
                                                <form action="{{ route('frontend.employee-ratings.destroy', $employeeRating->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
