            ...
            <div class="col-md-12">
                @can('employee_rating_create')
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-success" href="{{ route('frontend.employee-ratings.create') }}">
                            ...
                            @include('csvImport.modal', [
                                ...
                                'route' => 'admin.employee-ratings.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-EmployeeRating">
                                <thead>
                                    <tr>
                                        <th>
                                        ...
                                        <tr data-entry-id="{{ $employeeRating->id }}">
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" disabled="disabled"
                                                    {{ $employeeRating->show_online ? 'checked' : '' }}>
                                            </td>
                                            <td>
                                                @can('employee_rating_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.employee-ratings.show', $employeeRating->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('employee_rating_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.employee-ratings.edit', $employeeRating->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('employee_rating_delete')
                                                    <form
                                                        action="{{ route('frontend.employee-ratings.destroy', $employeeRating->id) }}"
                                                        method="POST"
        ...
        $(function() {
            ...
            @can('employee_rating_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('frontend.employee-ratings.massDestroy') }}",
            ...
            let table = $('.datatable-EmployeeRating:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
