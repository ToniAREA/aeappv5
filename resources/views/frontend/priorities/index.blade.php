                                            ...
                                            <td>
                                                @can('priority_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.priorities.show', $priority->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('priority_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.priorities.edit', $priority->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('priority_delete')
                                                    <form action="{{ route('frontend.priorities.destroy', $priority->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Priority:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
