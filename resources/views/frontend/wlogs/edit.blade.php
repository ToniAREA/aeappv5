        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.wlogs.update', [$wlog->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="wlist_id" id="wlist_id">
                                    @foreach ($wlists as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('wlist_id') ? old('wlist_id') : $wlog->wlist->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('wlist'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="boat_namecomplete" id="boat_namecomplete"
                                    value="{{ old('boat_namecomplete', $wlog->boat_namecomplete) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" type="text" name="date" id="date"
                                    value="{{ old('date', $wlog->date) }}" required>
                                @if ($errors->has('date'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('date') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="employee_id" id="employee_id" required>
                                    @foreach ($employees as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('employee_id') ? old('employee_id') : $wlog->employee->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="marina_id" id="marina_id">
                                    @foreach ($marinas as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('marina_id') ? old('marina_id') : $wlog->marina->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="description">{{ trans('cruds.wlog.fields.description') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="hours" id="hours"
                                    value="{{ old('hours', $wlog->hours) }}" step="0.01" required max="24">
                                @if ($errors->has('hours'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('hours') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="hourly_rate" id="hourly_rate"
                                    value="{{ old('hourly_rate', $wlog->hourly_rate) }}" step="0.01">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="travel_cost_included" id="travel_cost_included"
                                        value="1"
                                        {{ $wlog->travel_cost_included || old('travel_cost_included', 0) === 1 ? 'checked' : '' }}>
                                    <label
                                        for="travel_cost_included">{{ trans('cruds.wlog.fields.travel_cost_included') }}</label>
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.wlog.fields.travel_cost_included_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label for="total_travel_cost">{{ trans('cruds.wlog.fields.total_travel_cost') }}</label>
                                <input class="form-control" type="number" name="total_travel_cost" id="total_travel_cost"
                                    value="{{ old('total_travel_cost', $wlog->total_travel_cost) }}" step="0.01">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="total_access_cost"
                                    id="total_access_cost"
                                    value="{{ old('total_access_cost', $wlog->total_access_cost) }}" step="0.01">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="wlist_finished" id="wlist_finished" value="1"
                                        {{ $wlog->wlist_finished || old('wlist_finished', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="invoiced_line" id="invoiced_line" value="1"
                                        {{ $wlog->invoiced_line || old('invoiced_line', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internal_notes" id="internal_notes"
                                    value="{{ old('internal_notes', $wlog->internal_notes) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="financial_document_id">{{ trans('cruds.wlog.fields.financial_document') }}</label>
                                <select class="form-control select2" name="financial_document_id"
                                    ...
                                    @foreach ($financial_documents as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('financial_document_id') ? old('financial_document_id') : $wlog->financial_document->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
