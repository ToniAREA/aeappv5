                            ...
                            <tbody>
                                @foreach($wlogs as $key => $wlog)
                                    <tr data-entry-id="{{ $wlog->id }}">
                                        ...
                                        <td>
                                            @can('wlog_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.wlogs.show', $wlog->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('wlog_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.wlogs.edit', $wlog->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('wlog_delete')
                                                <form action="{{ route('frontend.wlogs.destroy', $wlog->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
