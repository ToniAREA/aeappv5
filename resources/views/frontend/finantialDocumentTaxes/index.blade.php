            ...
            <div class="col-md-12">
                @can('finantial_document_tax_create')
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-success" href="{{ route('frontend.finantial-document-taxes.create') }}">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'FinantialDocumentTax',
                                'route' => 'admin.finantial-document-taxes.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-FinantialDocumentTax">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('finantial_document_tax_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.finantial-document-taxes.show', $finantialDocumentTax->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('finantial_document_tax_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.finantial-document-taxes.edit', $finantialDocumentTax->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('finantial_document_tax_delete')
                                                    <form
                                                        action="{{ route('frontend.finantial-document-taxes.destroy', $finantialDocumentTax->id) }}"
                                                        method="POST"
        ...
        $(function() {
            ...
            @can('finantial_document_tax_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('frontend.finantial-document-taxes.massDestroy') }}",
            ...
            let table = $('.datatable-FinantialDocumentTax:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
