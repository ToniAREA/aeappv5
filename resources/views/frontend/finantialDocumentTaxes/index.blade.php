                                    ...
                                    <tr data-entry-id="{{ $finantialDocumentTax->id }}">
                                        ...
                                        <td>
                                            @can('finantial_document_tax_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.finantial-document-taxes.show', $finantialDocumentTax->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('finantial_document_tax_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.finantial-document-taxes.edit', $finantialDocumentTax->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('finantial_document_tax_delete')
                                                <form action="{{ route('frontend.finantial-document-taxes.destroy', $finantialDocumentTax->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
