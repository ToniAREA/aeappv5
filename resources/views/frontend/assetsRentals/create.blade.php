        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.assets-rentals.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="rental_unit" id="rental_unit" required>
                                    ...
                                    @foreach (App\Models\AssetsRental::RENTAL_UNIT_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('rental_unit', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="rental_quantity" id="rental_quantity"
                                    value="{{ old('rental_quantity', '') }}" step="1" required>
