        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.assets-rentals.update', [$assetsRental->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_active" id="is_active" value="1"
                                        {{ $assetsRental->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                                    <label for="is_active">{{ trans('cruds.assetsRental.fields.is_active') }}</label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="asset_id" id="asset_id">
                                    @foreach ($assets as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('asset_id') ? old('asset_id') : $assetsRental->asset->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('asset'))
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="user_id" id="user_id">
                                    @foreach ($users as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('user_id') ? old('user_id') : $assetsRental->user->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('user'))
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="client_id" id="client_id">
                                    @foreach ($clients as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('client_id') ? old('client_id') : $assetsRental->client->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boat_id" id="boat_id">
                                    @foreach ($boats as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('boat_id') ? old('boat_id') : $assetsRental->boat->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('boat'))
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="start_date">{{ trans('cruds.assetsRental.fields.start_date') }}</label>
                                <input class="form-control date" type="text" name="start_date" id="start_date"
                                    value="{{ old('start_date', $assetsRental->start_date) }}" required>
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="end_date">{{ trans('cruds.assetsRental.fields.end_date') }}</label>
                                <input class="form-control" type="text" name="end_date" id="end_date"
                                    value="{{ old('end_date', $assetsRental->end_date) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="rental_details" id="rental_details"
                                    value="{{ old('rental_details', $assetsRental->rental_details) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.assetsRental.fields.rental_details_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <div>
                                    <input type="hidden" name="invoiced" value="0">
                                    <input type="checkbox" name="invoiced" id="invoiced" value="1"
                                        {{ $assetsRental->invoiced || old('invoiced', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link" id="link"
                                    value="{{ old('link', $assetsRental->link) }}">
                                @if ($errors->has('link'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('link') }}
                                    </div>
                            ...
                            <div class="form-group">
                                <label
                                    for="link_description">{{ trans('cruds.assetsRental.fields.link_description') }}</label>
                                <input class="form-control" type="text" name="link_description" id="link_description"
                                    value="{{ old('link_description', $assetsRental->link_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.assetsRental.fields.link_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="completed_at"
                                    id="completed_at" value="{{ old('completed_at', $assetsRental->completed_at) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.assetsRental.fields.completed_at_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="rental_unit" id="rental_unit" required>
                                    <option value disabled {{ old('rental_unit', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\AssetsRental::RENTAL_UNIT_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('rental_unit', $assetsRental->rental_unit) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.assetsRental.fields.rental_unit_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label class="required"
                                    for="rental_quantity">{{ trans('cruds.assetsRental.fields.rental_quantity') }}</label>
                                <input class="form-control" type="number" name="rental_quantity" id="rental_quantity"
                                    value="{{ old('rental_quantity', $assetsRental->rental_quantity) }}" step="1"
                                    required>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.assetsRental.fields.rental_quantity_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label
                                    for="financial_document_id">{{ trans('cruds.assetsRental.fields.financial_document') }}</label>
                                <select class="form-control select2" name="financial_document_id"
                                    ...
                                    @foreach ($financial_documents as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('financial_document_id') ? old('financial_document_id') : $assetsRental->financial_document->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.assetsRental.fields.financial_document_helper') }}</span>
                            </div>
                            <div class="form-group">
