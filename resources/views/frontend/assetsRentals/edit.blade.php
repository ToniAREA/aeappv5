    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assets-rentals.update", [$assetsRental->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $assetsRental->start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="end_date" id="end_date" value="{{ old('end_date', $assetsRental->end_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="rental_details" id="rental_details" value="{{ old('rental_details', $assetsRental->rental_details) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $assetsRental->active || old('active', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="invoiced" id="invoiced" value="1" {{ $assetsRental->invoiced || old('invoiced', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="proforma_id" id="proforma_id">
                                @foreach($proformas as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('proforma_id') ? old('proforma_id') : $assetsRental->proforma->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $assetsRental->link) }}">
                            @if($errors->has('link'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('link') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_description" id="link_description" value="{{ old('link_description', $assetsRental->link_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="completed_at" id="completed_at" value="{{ old('completed_at', $assetsRental->completed_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rental_quantity" id="rental_quantity" value="{{ old('rental_quantity', $assetsRental->rental_quantity) }}" step="1" required>
