                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'AssetsRental',
                                'route' => 'admin.assets-rentals.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                        ...
                                        <tr data-entry-id="{{ $assetsRental->id }}">
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" disabled="disabled"
                                                    {{ $assetsRental->is_active ? 'checked' : '' }}>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @can('assets_rental_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.assets-rentals.show', $assetsRental->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('assets_rental_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.assets-rentals.edit', $assetsRental->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('assets_rental_delete')
                                                    <form
                                                        action="{{ route('frontend.assets-rentals.destroy', $assetsRental->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-AssetsRental:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
