            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-AssetsRental">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $assetsRental->id }}">
                                        ...
                                        <td>
                                            @can('assets_rental_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.assets-rentals.show', $assetsRental->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('assets_rental_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.assets-rentals.edit', $assetsRental->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('assets_rental_delete')
                                                <form action="{{ route('frontend.assets-rentals.destroy', $assetsRental->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('assets_rental_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.assets-rentals.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-AssetsRental:not(.ajaxTable)').DataTable({ buttons: dtButtons })
