                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                ...
                                'route' => 'admin.income-categories.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-IncomeCategory">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('income_category_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.income-categories.show', $incomeCategory->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('income_category_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.income-categories.edit', $incomeCategory->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('income_category_delete')
                                                    <form
                                                        action="{{ route('frontend.income-categories.destroy', $incomeCategory->id) }}"
                                                        method="POST"
