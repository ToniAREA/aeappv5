        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.insurances.update', [$insurance->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_active" id="is_active" value="1"
                                        {{ $insurance->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="provider_name">{{ trans('cruds.insurance.fields.provider_name') }}</label>
                                <input class="form-control" type="text" name="provider_name" id="provider_name"
                                    value="{{ old('provider_name', $insurance->provider_name) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="company_id" id="company_id">
                                    @foreach ($companies as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('company_id') ? old('company_id') : $insurance->company->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="policy_number" id="policy_number"
                                ...
                                @foreach (App\Models\Insurance::PERIOD_RADIO as $key => $label)
                                    <div>
                                        <input type="radio" id="period_{{ $key }}" name="period"
                                            value="{{ $key }}"
                                            {{ old('period', $insurance->period) === (string) $key ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="period_cost" id="period_cost"
                                    value="{{ old('period_cost', $insurance->period_cost) }}" step="0.01">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="coverage_type" id="coverage_type"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" type="text" name="start_date" id="start_date"
                                    value="{{ old('start_date', $insurance->start_date) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" type="text" name="end_date" id="end_date"
                                    value="{{ old('end_date', $insurance->end_date) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internalnotes" id="internalnotes"
                                    value="{{ old('internalnotes', $insurance->internalnotes) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link_a" id="link_a"
                                    value="{{ old('link_a', $insurance->link_a) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_a_description">{{ trans('cruds.insurance.fields.link_a_description') }}</label>
                                <input class="form-control" type="text" name="link_a_description"
                                    id="link_a_description"
                                    value="{{ old('link_a_description', $insurance->link_a_description) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_b_description">{{ trans('cruds.insurance.fields.link_b_description') }}</label>
                                <input class="form-control" type="text" name="link_b_description"
                                    id="link_b_description"
                                    value="{{ old('link_b_description', $insurance->link_b_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.insurance.fields.link_b_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="contacts[]" id="contacts" multiple>
                                    @foreach ($contacts as $id => $contact)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('contacts', [])) || $insurance->contacts->contains($id) ? 'selected' : '' }}>
                                            {{ $contact }}</option>
                                    @endforeach
                                </select>
