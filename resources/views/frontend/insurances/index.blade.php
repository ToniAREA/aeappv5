                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'Insurance',
                                'route' => 'admin.insurances.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                        ...
                                        <tr data-entry-id="{{ $insurance->id }}">
                                            ...
                                            <td>
                                                @if ($insurance->insurance_logo)
                                                    <a href="{{ $insurance->insurance_logo->getUrl() }}" target="_blank"
                                            ...
                                            <td>
                                                @can('insurance_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.insurances.show', $insurance->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('insurance_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.insurances.edit', $insurance->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('insurance_delete')
                                                    <form action="{{ route('frontend.insurances.destroy', $insurance->id) }}"
                                                        method="POST"
        ...
        $(function() {
            ...
            @can('insurance_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('frontend.insurances.massDestroy') }}",
            ...
            let table = $('.datatable-Insurance:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
