    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.iot-suscriptions.update", [$iotSuscription->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $iotSuscription->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $iotSuscription->start_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $iotSuscription->end_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="hourly_rate" id="hourly_rate" value="{{ old('hourly_rate', $iotSuscription->hourly_rate) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="hourly_rate_discount" id="hourly_rate_discount" value="{{ old('hourly_rate_discount', $iotSuscription->hourly_rate_discount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="material_discount" id="material_discount" value="{{ old('material_discount', $iotSuscription->material_discount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $iotSuscription->link) }}">
                            @if($errors->has('link'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('link') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_description" id="link_description" value="{{ old('link_description', $iotSuscription->link_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="notes" id="notes" value="{{ old('notes', $iotSuscription->notes) }}">
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="internalnotes" id="internalnotes" value="{{ old('internalnotes', $iotSuscription->internalnotes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="completed_at" id="completed_at" value="{{ old('completed_at', $iotSuscription->completed_at) }}">
