                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="product_price" id="product_price" value="{{ old('product_price', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="purchase_discount" id="purchase_discount" value="{{ old('purchase_discount', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_stock" id="has_stock" value="1" {{ old('has_stock', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="stock" id="stock" value="{{ old('stock', '') }}" step="1">
                            @if($errors->has('stock'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('stock') }}
                                </div>
