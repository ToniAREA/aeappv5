                        ...
                        <form method="POST" action="{{ route('frontend.products.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="providers[]" id="providers" multiple>
                                    @foreach ($providers as $id => $provider)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('providers', [])) ? 'selected' : '' }}>
                                            {{ $provider }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="purchase_discount"
                                    id="purchase_discount" value="{{ old('purchase_discount', '') }}" step="0.01">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="product_location_id" id="product_location_id">
                                    @foreach ($product_locations as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('product_location_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
