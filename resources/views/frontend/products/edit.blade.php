        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.products.update', [$product->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_online" id="is_online" value="1"
                                        {{ $product->is_online || old('is_online', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="ref_manu" id="ref_manu"
                                    value="{{ old('ref_manu', $product->ref_manu) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="providers[]" id="providers" multiple>
                                    @foreach ($providers as $id => $provider)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('providers', [])) || $product->providers->contains($id) ? 'selected' : '' }}>
                                            {{ $provider }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="ref_provider" id="ref_provider"
                                    value="{{ old('ref_provider', $product->ref_provider) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="purchase_discount">{{ trans('cruds.product.fields.purchase_discount') }}</label>
                                <input class="form-control" type="number" name="purchase_discount"
                                    id="purchase_discount"
                                    value="{{ old('purchase_discount', $product->purchase_discount) }}" step="0.01">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.product.fields.purchase_discount_helper') }}</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="has_stock" id="has_stock" value="1"
                                        {{ $product->has_stock || old('has_stock', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="stock" id="stock"
                                    value="{{ old('stock', $product->stock) }}" step="1">
                                @if ($errors->has('stock'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('stock') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="local_stock" id="local_stock"
                                    value="{{ old('local_stock', $product->local_stock) }}" step="1">
                            ...
                            <div class="form-group">
                                <label
                                    for="product_location_id">{{ trans('cruds.product.fields.product_location') }}</label>
                                <select class="form-control select2" name="product_location_id" id="product_location_id">
                                    @foreach ($product_locations as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('product_location_id') ? old('product_location_id') : $product->product_location->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.product.fields.product_location_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="tags[]" id="tags" multiple>
                                    @foreach ($tags as $id => $tag)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('tags', [])) || $product->tags->contains($id) ? 'selected' : '' }}>
                                            {{ $tag }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('tags'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link_a" id="link_a"
                                    value="{{ old('link_a', $product->link_a) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_a_description">{{ trans('cruds.product.fields.link_a_description') }}</label>
                                <input class="form-control" type="text" name="link_a_description"
                                    id="link_a_description"
                                    value="{{ old('link_a_description', $product->link_a_description) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_b_description">{{ trans('cruds.product.fields.link_b_description') }}</label>
                                <input class="form-control" type="text" name="link_b_description"
                                    id="link_b_description"
                                    value="{{ old('link_b_description', $product->link_b_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.product.fields.link_b_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label
                                    for="seo_meta_description">{{ trans('cruds.product.fields.seo_meta_description') }}</label>
                                <input class="form-control" type="text" name="seo_meta_description"
                                    id="seo_meta_description"
                                    value="{{ old('seo_meta_description', $product->seo_meta_description) }}">
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('frontend.products.storeCKEditorImages') }}',
                                            true);
