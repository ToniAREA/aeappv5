            ...
            <div class="col-md-12">
                @can('expense_category_create')
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-success" href="{{ route('frontend.expense-categories.create') }}">
                                            ...
                                            <td>
                                                @can('expense_category_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.expense-categories.show', $expenseCategory->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('expense_category_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.expense-categories.edit', $expenseCategory->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('expense_category_delete')
                                                    <form
                                                        action="{{ route('frontend.expense-categories.destroy', $expenseCategory->id) }}"
                                                        method="POST"
        ...
        $(function() {
            ...
            @can('expense_category_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('frontend.expense-categories.massDestroy') }}",
