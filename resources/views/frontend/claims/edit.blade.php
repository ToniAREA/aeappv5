        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.claims.update', [$claim->id]) }}"
                            enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label for="claim_date">{{ trans('cruds.claim.fields.claim_date') }}</label>
                                <input class="form-control date" type="text" name="claim_date" id="claim_date"
