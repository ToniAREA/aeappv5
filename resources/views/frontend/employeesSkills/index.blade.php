                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-EmployeesSkill">
                                <thead>
                                    <tr>
                                        <th>
                                        ...
                                        <tr data-entry-id="{{ $employeesSkill->id }}">
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" disabled="disabled"
                                                    {{ $employeesSkill->verified ? 'checked' : '' }}>
                                            </td>
                                            <td>
                                                @can('employees_skill_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.employees-skills.show', $employeesSkill->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('employees_skill_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.employees-skills.edit', $employeesSkill->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('employees_skill_delete')
                                                    <form
                                                        action="{{ route('frontend.employees-skills.destroy', $employeesSkill->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-EmployeesSkill:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
