        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.content-pages.update', [$contentPage->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_online" id="is_online" value="1"
                                        {{ $contentPage->is_online || old('is_online', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" id="title"
                                    value="{{ old('title', $contentPage->title) }}" required>
                                @if ($errors->has('title'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('title') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="excerpt" id="excerpt">{!! old('excerpt', $contentPage->excerpt) !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.contentPage.fields.featured_image_helper') }}</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="seo_title" id="seo_title"
                                    value="{{ old('seo_title', $contentPage->seo_title) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="seo_meta_description">{{ trans('cruds.contentPage.fields.seo_meta_description') }}</label>
                                <input class="form-control" type="text" name="seo_meta_description"
                                    id="seo_meta_description"
                                    value="{{ old('seo_meta_description', $contentPage->seo_meta_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.contentPage.fields.seo_meta_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="seo_slug" id="seo_slug"
                                    value="{{ old('seo_slug', $contentPage->seo_slug) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link_a" id="link_a"
                                    value="{{ old('link_a', $contentPage->link_a) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_a_description">{{ trans('cruds.contentPage.fields.link_a_description') }}</label>
                                <input class="form-control" type="text" name="link_a_description"
                                    id="link_a_description"
                                    value="{{ old('link_a_description', $contentPage->link_a_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.contentPage.fields.link_a_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <div>
                                    <input type="hidden" name="show_online_link_a" value="0">
                                    <input type="checkbox" name="show_online_link_a" id="show_online_link_a"
                                        value="1"
                                        {{ $contentPage->show_online_link_a || old('show_online_link_a', 0) === 1 ? 'checked' : '' }}>
                                    <label
                                        for="show_online_link_a">{{ trans('cruds.contentPage.fields.show_online_link_a') }}</label>
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.contentPage.fields.show_online_link_a_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label for="link_b">{{ trans('cruds.contentPage.fields.link_b') }}</label>
                                <input class="form-control" type="text" name="link_b" id="link_b"
                                    value="{{ old('link_b', $contentPage->link_b) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_b_description">{{ trans('cruds.contentPage.fields.link_b_description') }}</label>
                                <input class="form-control" type="text" name="link_b_description"
                                    id="link_b_description"
                                    value="{{ old('link_b_description', $contentPage->link_b_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.contentPage.fields.link_b_description_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <div>
                                    <input type="hidden" name="show_online_link_b" value="0">
                                    <input type="checkbox" name="show_online_link_b" id="show_online_link_b"
                                        value="1"
                                        {{ $contentPage->show_online_link_b || old('show_online_link_b', 0) === 1 ? 'checked' : '' }}>
                                    <label
                                        for="show_online_link_b">{{ trans('cruds.contentPage.fields.show_online_link_b') }}</label>
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.contentPage.fields.show_online_link_b_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label for="view_count">{{ trans('cruds.contentPage.fields.view_count') }}</label>
                                <input class="form-control" type="number" name="view_count" id="view_count"
                                    value="{{ old('view_count', $contentPage->view_count) }}" step="1">
                            ...
                            <div class="form-group">
                                <label
                                    for="authorized_roles">{{ trans('cruds.contentPage.fields.authorized_roles') }}</label>
                                <div style="padding-bottom: 4px">
                                    <span class="btn btn-info btn-xs select-all"
                                        style="border-radius: 0">{{ trans('global.select_all') }}</span>
                                    <span class="btn btn-info btn-xs deselect-all"
                                ...
                                <select class="form-control select2" name="authorized_roles[]" id="authorized_roles"
                                    ...
                                    @foreach ($authorized_roles as $id => $authorized_role)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('authorized_roles', [])) || $contentPage->authorized_roles->contains($id) ? 'selected' : '' }}>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.contentPage.fields.authorized_roles_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label
                                    for="authorized_users">{{ trans('cruds.contentPage.fields.authorized_users') }}</label>
                                <div style="padding-bottom: 4px">
                                    <span class="btn btn-info btn-xs select-all"
                                        style="border-radius: 0">{{ trans('global.select_all') }}</span>
                                    <span class="btn btn-info btn-xs deselect-all"
                                ...
                                <select class="form-control select2" name="authorized_users[]" id="authorized_users"
                                    ...
                                    @foreach ($authorized_users as $id => $authorized_user)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('authorized_users', [])) || $contentPage->authorized_users->contains($id) ? 'selected' : '' }}>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.contentPage.fields.authorized_users_helper') }}</span>
                            </div>
                            <div class="form-group">
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('frontend.content-pages.storeCKEditorImages') }}',
                                            true);
