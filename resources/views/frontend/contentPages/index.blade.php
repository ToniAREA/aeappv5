                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'ContentPage',
                                'route' => 'admin.content-pages.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                ...
                                <tbody>
                                    @foreach ($contentPages as $key => $contentPage)
                                        <tr data-entry-id="{{ $contentPage->id }}">
                                            ...
                                            <td>
                                                <span
                                                    style="display:none">{{ $contentPage->show_online_link_a ?? '' }}</span>
                                                <input type="checkbox" disabled="disabled"
                                                    {{ $contentPage->show_online_link_a ? 'checked' : '' }}>
                                            </td>
                                            <td>
                                                {{ $contentPage->link_b ?? '' }}
                                            </td>
                                            ...
                                            <td>
                                                <span
                                                    style="display:none">{{ $contentPage->show_online_link_b ?? '' }}</span>
                                                <input type="checkbox" disabled="disabled"
                                                    {{ $contentPage->show_online_link_b ? 'checked' : '' }}>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @can('content_page_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.content-pages.show', $contentPage->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('content_page_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.content-pages.edit', $contentPage->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('content_page_delete')
                                                    <form
                                                        action="{{ route('frontend.content-pages.destroy', $contentPage->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-ContentPage:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
