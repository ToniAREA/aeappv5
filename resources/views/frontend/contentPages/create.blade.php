        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.content-pages.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="tags[]" id="tags" multiple>
                                    @foreach ($tags as $id => $tag)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('tags', [])) ? 'selected' : '' }}>{{ $tag }}
                                        </option>
                                    @endforeach
                                </select>
                                @if ($errors->has('tags'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="seo_meta_description"
                                    id="seo_meta_description" value="{{ old('seo_meta_description', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link_a_description"
                                    id="link_a_description" value="{{ old('link_a_description', '') }}">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="show_online_link_a" id="show_online_link_a"
                                        value="1"
                                        {{ old('show_online_link_a', 0) == 1 || old('show_online_link_a') === null ? 'checked' : '' }}>
                                    <label
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link_b_description"
                                    id="link_b_description" value="{{ old('link_b_description', '') }}">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="show_online_link_b" id="show_online_link_b"
                                        value="1"
                                        {{ old('show_online_link_b', 0) == 1 || old('show_online_link_b') === null ? 'checked' : '' }}>
                                    <label
