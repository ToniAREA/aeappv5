        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.payments.update', [$payment->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="id_transaction" id="id_transaction"
                                    value="{{ old('id_transaction', $payment->id_transaction) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="financial_document_id"
                                    ...
                                    @foreach ($financial_documents as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('financial_document_id') ? old('financial_document_id') : $payment->financial_document->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="total_amount" id="total_amount"
                                    value="{{ old('total_amount', $payment->total_amount) }}" step="0.01">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="currency_id" id="currency_id">
                                    @foreach ($currencies as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('currency_id') ? old('currency_id') : $payment->currency->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
