                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'Payment',
                                'route' => 'admin.payments.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                            ...
                                            <td>
                                                @can('payment_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.payments.show', $payment->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('payment_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.payments.edit', $payment->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('payment_delete')
                                                    <form action="{{ route('frontend.payments.destroy', $payment->id) }}"
                                                        method="POST"
