        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.checkpoints.update', [$checkpoint->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_available" id="is_available" value="1"
                                        {{ $checkpoint->is_available || old('is_available', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" id="name"
                                    value="{{ old('name', $checkpoint->name) }}" required>
                                @if ($errors->has('name'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('name') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description" id="description"
                                    value="{{ old('description', $checkpoint->description) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="groups[]" id="groups" multiple required>
                                    @foreach ($groups as $id => $group)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('groups', [])) || $checkpoint->groups->contains($id) ? 'selected' : '' }}>
                                            {{ $group }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="price" id="price"
                                    value="{{ old('price', $checkpoint->price) }}" step="0.01">
                                @if ($errors->has('price'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('price') }}
                                    </div>
