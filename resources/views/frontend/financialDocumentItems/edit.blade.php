    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.financial-document-items.update", [$financialDocumentItem->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $financialDocumentItem->description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="quantity" id="quantity" value="{{ old('quantity', $financialDocumentItem->quantity) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="unit_price" id="unit_price" value="{{ old('unit_price', $financialDocumentItem->unit_price) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="line_position" id="line_position" value="{{ old('line_position', $financialDocumentItem->line_position) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="subtotal" id="subtotal" value="{{ old('subtotal', $financialDocumentItem->subtotal) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', $financialDocumentItem->total_amount) }}" step="0.01">
