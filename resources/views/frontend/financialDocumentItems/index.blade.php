                                    ...
                                    <tr data-entry-id="{{ $financialDocumentItem->id }}">
                                        ...
                                        <td>
                                            @can('financial_document_item_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.financial-document-items.show', $financialDocumentItem->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('financial_document_item_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.financial-document-items.edit', $financialDocumentItem->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('financial_document_item_delete')
                                                <form action="{{ route('frontend.financial-document-items.destroy', $financialDocumentItem->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
