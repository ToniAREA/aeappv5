                                    ...
                                    <tr data-entry-id="{{ $employeeHoliday->id }}">
                                        ...
                                        <td>
                                            @can('employee_holiday_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.employee-holidays.show', $employeeHoliday->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('employee_holiday_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.employee-holidays.edit', $employeeHoliday->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('employee_holiday_delete')
                                                <form action="{{ route('frontend.employee-holidays.destroy', $employeeHoliday->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
