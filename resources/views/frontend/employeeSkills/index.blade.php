                                    ...
                                    <tr data-entry-id="{{ $employeeSkill->id }}">
                                        ...
                                        <td>
                                            @can('employee_skill_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.employee-skills.show', $employeeSkill->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('employee_skill_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.employee-skills.edit', $employeeSkill->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('employee_skill_delete')
                                                <form action="{{ route('frontend.employee-skills.destroy', $employeeSkill->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
