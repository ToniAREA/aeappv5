    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clients-reviews.update", [$clientsReview->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rating" id="rating" value="{{ old('rating', $clientsReview->rating) }}" step="0.1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="shown_online" id="shown_online" value="1" {{ $clientsReview->shown_online || old('shown_online', 0) === 1 ? 'checked' : '' }}>
