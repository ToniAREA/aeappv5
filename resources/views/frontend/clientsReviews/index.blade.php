                                    ...
                                    <tr data-entry-id="{{ $clientsReview->id }}">
                                        ...
                                        <td>
                                            @can('clients_review_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.clients-reviews.show', $clientsReview->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('clients_review_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.clients-reviews.edit', $clientsReview->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('clients_review_delete')
                                                <form action="{{ route('frontend.clients-reviews.destroy', $clientsReview->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
