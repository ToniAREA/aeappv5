                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'MatLog',
                                'route' => 'admin.mat-logs.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                            ...
                                            <td>
                                                @can('mat_log_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.mat-logs.show', $matLog->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('mat_log_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.mat-logs.edit', $matLog->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('mat_log_delete')
                                                    <form action="{{ route('frontend.mat-logs.destroy', $matLog->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-MatLog:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
