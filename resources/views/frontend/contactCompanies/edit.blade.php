        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.contact-companies.update', [$contactCompany->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="defaulter" id="defaulter" value="1"
                                        {{ $contactCompany->defaulter || old('defaulter', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="company_vat" id="company_vat"
                                    value="{{ old('company_vat', $contactCompany->company_vat) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="company_mobile" id="company_mobile"
                                    value="{{ old('company_mobile', $contactCompany->company_mobile) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="company_phone" id="company_phone"
                                    value="{{ old('company_phone', $contactCompany->company_phone) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="company_social_link"
                                    id="company_social_link"
                                    value="{{ old('company_social_link', $contactCompany->company_social_link) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="contacts[]" id="contacts" multiple>
                                    @foreach ($contacts as $id => $contact)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('contacts', [])) || $contactCompany->contacts->contains($id) ? 'selected' : '' }}>
                                            {{ $contact }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link" id="link"
                                    value="{{ old('link', $contactCompany->link) }}">
                                @if ($errors->has('link'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('link') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="link_description" id="link_description"
                                    value="{{ old('link_description', $contactCompany->link_description) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="last_use" id="last_use"
                                    value="{{ old('last_use', $contactCompany->last_use) }}">
