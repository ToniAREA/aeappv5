                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                ...
                                'route' => 'admin.contact-companies.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-ContactCompany">
                                <thead>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            <select class="search">
                                                ...
                                                @foreach ($contact_contacts as $key => $item)
                                                    <option value="{{ $item->contact_first_name }}">
                                                        {{ $item->contact_first_name }}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td>
                                        ...
                                        <tr data-entry-id="{{ $contactCompany->id }}">
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" disabled="disabled"
                                                    {{ $contactCompany->defaulter ? 'checked' : '' }}>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if ($contactCompany->company_logo)
                                                    <a href="{{ $contactCompany->company_logo->getUrl() }}" target="_blank"
                                            ...
                                            <td>
                                                @can('contact_company_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.contact-companies.show', $contactCompany->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('contact_company_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.contact-companies.edit', $contactCompany->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('contact_company_delete')
                                                    <form
                                                        action="{{ route('frontend.contact-companies.destroy', $contactCompany->id) }}"
                                                        method="POST"
