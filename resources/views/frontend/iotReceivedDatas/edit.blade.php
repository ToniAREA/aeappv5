    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.iot-received-datas.update", [$iotReceivedData->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="security_token" id="security_token" value="{{ old('security_token', $iotReceivedData->security_token) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="service_voltage" id="service_voltage" value="{{ old('service_voltage', $iotReceivedData->service_voltage) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="engine_1_voltage" id="engine_1_voltage" value="{{ old('engine_1_voltage', $iotReceivedData->engine_1_voltage) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="engine_2_voltage" id="engine_2_voltage" value="{{ old('engine_2_voltage', $iotReceivedData->engine_2_voltage) }}" step="0.01">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="bilge_alarm" id="bilge_alarm" value="1" {{ $iotReceivedData->bilge_alarm || old('bilge_alarm', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="shore_alarm" id="shore_alarm" value="1" {{ $iotReceivedData->shore_alarm || old('shore_alarm', 0) === 1 ? 'checked' : '' }}>
