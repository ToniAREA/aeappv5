                                    ...
                                    <tr data-entry-id="{{ $iotReceivedData->id }}">
                                        ...
                                        <td>
                                            @can('iot_received_data_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.iot-received-datas.show', $iotReceivedData->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('iot_received_data_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.iot-received-datas.edit', $iotReceivedData->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('iot_received_data_delete')
                                                <form action="{{ route('frontend.iot-received-datas.destroy', $iotReceivedData->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('iot_received_data_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.iot-received-datas.massDestroy') }}",
