            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-Suscription">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $suscription->id }}">
                                        ...
                                        <td>
                                            @can('suscription_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.suscriptions.show', $suscription->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('suscription_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.suscriptions.edit', $suscription->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('suscription_delete')
                                                <form action="{{ route('frontend.suscriptions.destroy', $suscription->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('suscription_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.suscriptions.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Suscription:not(.ajaxTable)').DataTable({ buttons: dtButtons })
