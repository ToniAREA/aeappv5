                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'Suscription',
                                'route' => 'admin.suscriptions.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                        ...
                                        <tr data-entry-id="{{ $suscription->id }}">
                                            ...
                                            <td>
                                                @if ($suscription->signed_contract)
                                                    <a href="{{ $suscription->signed_contract->getUrl() }}"
                                                        target="_blank">
                                            ...
                                            <td>
                                                @can('suscription_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.suscriptions.show', $suscription->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('suscription_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.suscriptions.edit', $suscription->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('suscription_delete')
                                                    <form
                                                        action="{{ route('frontend.suscriptions.destroy', $suscription->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Suscription:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
