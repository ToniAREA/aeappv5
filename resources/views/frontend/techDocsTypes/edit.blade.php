        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.tech-docs-types.update', [$techDocsType->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_online" id="is_online" value="1"
                                        {{ $techDocsType->is_online || old('is_online', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" id="name"
                                    value="{{ old('name', $techDocsType->name) }}">
                                @if ($errors->has('name'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('name') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description" id="description"
                                    value="{{ old('description', $techDocsType->description) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="authorized_roles[]" id="authorized_roles"
                                    ...
                                    @foreach ($authorized_roles as $id => $authorized_role)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('authorized_roles', [])) || $techDocsType->authorized_roles->contains($id) ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="authorized_users[]" id="authorized_users"
                                    ...
                                    @foreach ($authorized_users as $id => $authorized_user)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('authorized_users', [])) || $techDocsType->authorized_users->contains($id) ? 'selected' : '' }}>
