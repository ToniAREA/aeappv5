            ...
            <div class="col-md-12">
                @can('video_category_create')
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-success" href="{{ route('frontend.video-categories.create') }}">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'VideoCategory',
                                'route' => 'admin.video-categories.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-VideoCategory">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('video_category_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.video-categories.show', $videoCategory->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('video_category_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.video-categories.edit', $videoCategory->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('video_category_delete')
                                                    <form
                                                        action="{{ route('frontend.video-categories.destroy', $videoCategory->id) }}"
                                                        method="POST"
        ...
        $(function() {
            ...
            @can('video_category_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('frontend.video-categories.massDestroy') }}",
            ...
            let table = $('.datatable-VideoCategory:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
