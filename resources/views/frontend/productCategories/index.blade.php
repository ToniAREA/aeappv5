                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                ...
                                'route' => 'admin.product-categories.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-ProductCategory">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('product_category_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.product-categories.show', $productCategory->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('product_category_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.product-categories.edit', $productCategory->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('product_category_delete')
                                                    <form
                                                        action="{{ route('frontend.product-categories.destroy', $productCategory->id) }}"
                                                        method="POST"
