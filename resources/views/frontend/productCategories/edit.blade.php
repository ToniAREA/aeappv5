                    ...
                    <form method="POST" action="{{ route("frontend.product-categories.update", [$productCategory->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_online" id="is_online" value="1" {{ $productCategory->is_online || old('is_online', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="category_slug" id="category_slug" value="{{ old('category_slug', $productCategory->category_slug) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $productCategory->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="authorized_roles[]" id="authorized_roles" multiple required>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.product-categories.storeCKEditorImages') }}', true);
