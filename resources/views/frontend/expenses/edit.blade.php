        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.expenses.update', [$expense->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_accounted" id="is_accounted" value="1"
                                        {{ $expense->is_accounted || old('is_accounted', 0) === 1 ? 'checked' : '' }}>
                                    <label for="is_accounted">{{ trans('cruds.expense.fields.is_accounted') }}</label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="employee_id" id="employee_id">
                                    @foreach ($employees as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('employee_id') ? old('employee_id') : $expense->employee->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label
                                    for="expense_category_id">{{ trans('cruds.expense.fields.expense_category') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" type="text" name="entry_date" id="entry_date"
                                    value="{{ old('entry_date', $expense->entry_date) }}" required>
