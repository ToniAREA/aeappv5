        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.booking-lists.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="booking_slot_id" id="booking_slot_id">
                                    @foreach ($booking_slots as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('booking_slot_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="hours" id="hours"
                                    value="{{ old('hours', '1') }}" step="1" min="1" max="100">
                                @if ($errors->has('hours'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('hours') }}
                                    </div>
