                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'Bank',
                                'route' => 'admin.banks.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                ...
                                <tbody>
                                    @foreach ($banks as $key => $bank)
                                        <tr data-entry-id="{{ $bank->id }}">
                                            ...
                                            <td>
                                                @if ($bank->bank_logo)
                                                    <a href="{{ $bank->bank_logo->getUrl() }}" target="_blank"
                                            ...
                                            <td>
                                                @can('bank_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.banks.show', $bank->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('bank_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.banks.edit', $bank->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('bank_delete')
                                                    <form action="{{ route('frontend.banks.destroy', $bank->id) }}"
                                                        method="POST"
