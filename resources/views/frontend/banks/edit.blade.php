        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.banks.update', [$bank->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_active" id="is_active" value="1"
                                        {{ $bank->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="account_number">{{ trans('cruds.bank.fields.account_number') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" type="text" name="join_date" id="join_date"
                                    value="{{ old('join_date', $bank->join_date) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="current_balance" id="current_balance"
                                    value="{{ old('current_balance', $bank->current_balance) }}" step="0.01">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internal_notes" id="internal_notes"
                                    value="{{ old('internal_notes', $bank->internal_notes) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_a_description">{{ trans('cruds.bank.fields.link_a_description') }}</label>
                                <input class="form-control" type="text" name="link_a_description"
                                    id="link_a_description"
                                    value="{{ old('link_a_description', $bank->link_a_description) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_b_description">{{ trans('cruds.bank.fields.link_b_description') }}</label>
                                <input class="form-control" type="text" name="link_b_description"
                                    id="link_b_description"
                                    value="{{ old('link_b_description', $bank->link_b_description) }}">
