                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'Availability',
                                'route' => 'admin.availabilities.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                            ...
                                            <td>
                                                @can('availability_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.availabilities.show', $availability->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('availability_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.availabilities.edit', $availability->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('availability_delete')
                                                    <form
                                                        action="{{ route('frontend.availabilities.destroy', $availability->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Availability:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
