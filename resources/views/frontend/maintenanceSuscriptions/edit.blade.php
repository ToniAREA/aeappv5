    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.maintenance-suscriptions.update", [$maintenanceSuscription->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $maintenanceSuscription->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $maintenanceSuscription->start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $maintenanceSuscription->end_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="material_discount" id="material_discount" value="{{ old('material_discount', $maintenanceSuscription->material_discount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $maintenanceSuscription->link) }}">
                            @if($errors->has('link'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('link') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_description" id="link_description" value="{{ old('link_description', $maintenanceSuscription->link_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="notes" id="notes" value="{{ old('notes', $maintenanceSuscription->notes) }}">
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="internalnotes" id="internalnotes" value="{{ old('internalnotes', $maintenanceSuscription->internalnotes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="completed_at" id="completed_at" value="{{ old('completed_at', $maintenanceSuscription->completed_at) }}">
