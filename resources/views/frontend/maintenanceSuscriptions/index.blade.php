                                    ...
                                    <tr data-entry-id="{{ $maintenanceSuscription->id }}">
                                        ...
                                        <td>
                                            @can('maintenance_suscription_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.maintenance-suscriptions.show', $maintenanceSuscription->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('maintenance_suscription_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.maintenance-suscriptions.edit', $maintenanceSuscription->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('maintenance_suscription_delete')
                                                <form action="{{ route('frontend.maintenance-suscriptions.destroy', $maintenanceSuscription->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
