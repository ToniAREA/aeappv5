                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'AssetCategory',
                                'route' => 'admin.asset-categories.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                class=" table table-bordered table-striped table-hover datatable datatable-AssetCategory">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('asset_category_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.asset-categories.show', $assetCategory->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('asset_category_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.asset-categories.edit', $assetCategory->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('asset_category_delete')
                                                    <form
                                                        action="{{ route('frontend.asset-categories.destroy', $assetCategory->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-AssetCategory:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
