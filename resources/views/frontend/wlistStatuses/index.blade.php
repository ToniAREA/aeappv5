                                    ...
                                    <tr data-entry-id="{{ $wlistStatus->id }}">
                                        ...
                                        <td>
                                            @can('wlist_status_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.wlist-statuses.show', $wlistStatus->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('wlist_status_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.wlist-statuses.edit', $wlistStatus->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('wlist_status_delete')
                                                <form action="{{ route('frontend.wlist-statuses.destroy', $wlistStatus->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('wlist_status_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.wlist-statuses.massDestroy') }}",
