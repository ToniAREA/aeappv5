        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.appointments.update', [$appointment->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="client_id" id="client_id">
                                    @foreach ($clients as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('client_id') ? old('client_id') : $appointment->client->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boat_id" id="boat_id">
                                    @foreach ($boats as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('boat_id') ? old('boat_id') : $appointment->boat->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('boat'))
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="wlists[]" id="wlists" multiple>
                                    @foreach ($wlists as $id => $wlist)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('wlists', [])) || $appointment->wlists->contains($id) ? 'selected' : '' }}>
                                            {{ $wlist }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="for_roles[]" id="for_roles" multiple>
                                    @foreach ($for_roles as $id => $for_role)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('for_roles', [])) || $appointment->for_roles->contains($id) ? 'selected' : '' }}>
                                            {{ $for_role }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="for_employees[]" id="for_employees" multiple>
                                    @foreach ($for_employees as $id => $for_employee)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('for_employees', [])) || $appointment->for_employees->contains($id) ? 'selected' : '' }}>
                                            {{ $for_employee }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="boat_namecomplete" id="boat_namecomplete"
                                    value="{{ old('boat_namecomplete', $appointment->boat_namecomplete) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="in_marina_id" id="in_marina_id">
                                    @foreach ($in_marinas as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('in_marina_id') ? old('in_marina_id') : $appointment->in_marina->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description" id="description"
                                    value="{{ old('description', $appointment->description) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="private_comment" id="private_comment"
                                    value="{{ old('private_comment', $appointment->private_comment) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="when_starts" id="when_starts"
                                    value="{{ old('when_starts', $appointment->when_starts) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="when_ends" id="when_ends"
                                    value="{{ old('when_ends', $appointment->when_ends) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="priority" id="priority"
                                    value="{{ old('priority', $appointment->priority) }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="coordinates" id="coordinates"
                                    value="{{ old('coordinates', $appointment->coordinates) }}">
