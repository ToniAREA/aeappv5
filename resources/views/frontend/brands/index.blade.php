                    ...
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12">
                            ...
                            @include('csvImport.modal', [
                                'model' => 'Brand',
                                'route' => 'admin.brands.parseCsvImport',
                            ])
                        </div>
                    </div>
                @endcan
                                ...
                                <tbody>
                                    @foreach ($brands as $key => $brand)
                                        <tr data-entry-id="{{ $brand->id }}">
                                            ...
                                            <td>
                                                @if ($brand->brand_logo)
                                                    <a href="{{ $brand->brand_logo->getUrl() }}" target="_blank"
                                            ...
                                            <td>
                                                @can('brand_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.brands.show', $brand->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('brand_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.brands.edit', $brand->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('brand_delete')
                                                    <form action="{{ route('frontend.brands.destroy', $brand->id) }}"
                                                        method="POST"
