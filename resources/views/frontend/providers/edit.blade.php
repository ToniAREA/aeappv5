        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.providers.update', [$provider->id]) }}"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="is_active" id="is_active" value="1"
                                        {{ $provider->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="company_id" id="company_id">
                                    @foreach ($companies as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('company_id') ? old('company_id') : $provider->company->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="provider_url" id="provider_url"
                                    value="{{ old('provider_url', $provider->provider_url) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="brands[]" id="brands" multiple>
                                    @foreach ($brands as $id => $brand)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('brands', [])) || $provider->brands->contains($id) ? 'selected' : '' }}>
                                            {{ $brand }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="notes" id="notes"
                                    value="{{ old('notes', $provider->notes) }}">
                                @if ($errors->has('notes'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('notes') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="internal_notes" id="internal_notes"
                                    value="{{ old('internal_notes', $provider->internal_notes) }}">
                            ...
                            <div class="form-group">
                                <label
                                    for="link_description">{{ trans('cruds.provider.fields.link_description') }}</label>
                                <input class="form-control" type="text" name="link_description" id="link_description"
                                    value="{{ old('link_description', $provider->link_description) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.provider.fields.link_description_helper') }}</span>
                            </div>
                            <div class="form-group">
