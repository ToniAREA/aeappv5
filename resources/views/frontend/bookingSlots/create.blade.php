    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.booking-slots.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rate_multiplier" id="rate_multiplier" value="{{ old('rate_multiplier', '1') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="booked" id="booked" value="1" {{ old('booked', 0) == 1 ? 'checked' : '' }}>
