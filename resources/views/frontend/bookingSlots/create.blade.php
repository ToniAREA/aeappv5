            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        {{ trans('global.create') }} {{ trans('cruds.bookingSlot.title_singular') }}
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.booking-slots.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="rate_multiplier" id="rate_multiplier"
                                    value="{{ old('rate_multiplier', '1') }}" step="0.01" required>
