                                    ...
                                    <tr data-entry-id="{{ $bookingSlot->id }}">
                                        ...
                                        <td>
                                            @can('booking_slot_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.booking-slots.show', $bookingSlot->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('booking_slot_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.booking-slots.edit', $bookingSlot->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('booking_slot_delete')
                                                <form action="{{ route('frontend.booking-slots.destroy', $bookingSlot->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
