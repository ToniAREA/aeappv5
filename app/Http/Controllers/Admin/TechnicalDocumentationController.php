...
class TechnicalDocumentationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.technicalDocumentations.index', compact('technicalDocumentations'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.technicalDocumentations.create', compact('brands', 'doc_types', 'products'));
    }
    ...
    public function edit(TechnicalDocumentation $technicalDocumentation)
    {
        ...
        return view('admin.technicalDocumentations.edit', compact('brands', 'doc_types', 'products', 'technicalDocumentation'));
    }
