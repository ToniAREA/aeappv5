...
class EmployeeSkillsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.employeeSkills.index', compact('employeeSkills'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.employeeSkills.create', compact('employees', 'subjects'));
    }
    ...
    public function edit(EmployeeSkill $employeeSkill)
    {
        ...
        return view('admin.employeeSkills.edit', compact('employeeSkill', 'employees', 'subjects'));
    }
