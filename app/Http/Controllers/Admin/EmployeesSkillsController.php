...
class EmployeesSkillsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.employeesSkills.index', compact('employeesSkills'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.employeesSkills.create', compact('employees', 'subjects'));
    }
    ...
    public function store(StoreEmployeesSkillRequest $request)
    {
        ...
        return redirect()->route('admin.employees-skills.index');
    }
    ...
    public function edit(EmployeesSkill $employeesSkill)
    {
        ...
        return view('admin.employeesSkills.edit', compact('employees', 'employeesSkill', 'subjects'));
    }
    ...
    public function show(EmployeesSkill $employeesSkill)
    {
        ...
        return view('admin.employeesSkills.show', compact('employeesSkill'));
    }
