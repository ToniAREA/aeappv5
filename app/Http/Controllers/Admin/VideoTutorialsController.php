...
class VideoTutorialsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.videoTutorials.index', compact('videoTutorials'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.videoTutorials.create', compact('subjects'));
    }
    ...
    public function edit(VideoTutorial $videoTutorial)
    {
        ...
        return view('admin.videoTutorials.edit', compact('subjects', 'videoTutorial'));
    }
