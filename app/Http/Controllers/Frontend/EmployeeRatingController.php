...
class EmployeeRatingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.employeeRatings.index', compact('employeeRatings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.employeeRatings.create', compact('employees', 'for_wlists', 'for_wlogs', 'from_clients', 'from_users'));
    }
    ...
    public function store(StoreEmployeeRatingRequest $request)
    {
        ...
        return redirect()->route('frontend.employee-ratings.index');
    }
    ...
    public function edit(EmployeeRating $employeeRating)
    {
        ...
        return view('frontend.employeeRatings.edit', compact('employeeRating', 'employees', 'for_wlists', 'for_wlogs', 'from_clients', 'from_users'));
    }
    ...
    public function show(EmployeeRating $employeeRating)
    {
        ...
        return view('frontend.employeeRatings.show', compact('employeeRating'));
    }
