...
class EmployeeAttendancesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.employeeAttendances.index', compact('employeeAttendances'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.employeeAttendances.create', compact('employees'));
    }
    ...
    public function store(StoreEmployeeAttendanceRequest $request)
    {
        ...
        return redirect()->route('frontend.employee-attendances.index');
    }
    ...
    public function edit(EmployeeAttendance $employeeAttendance)
    {
        ...
        return view('frontend.employeeAttendances.edit', compact('employeeAttendance', 'employees'));
    }
    ...
    public function show(EmployeeAttendance $employeeAttendance)
    {
        ...
        return view('frontend.employeeAttendances.show', compact('employeeAttendance'));
    }
