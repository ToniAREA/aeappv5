...
class ContactTagController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.contactTags.index', compact('contactTags'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.contactTags.create');
    }
    ...
    public function store(StoreContactTagRequest $request)
    {
        ...
        return redirect()->route('frontend.contact-tags.index');
    }
    ...
    public function edit(ContactTag $contactTag)
    {
        ...
        return view('frontend.contactTags.edit', compact('contactTag'));
    }
    ...
    public function show(ContactTag $contactTag)
    {
        ...
        return view('frontend.contactTags.show', compact('contactTag'));
    }
