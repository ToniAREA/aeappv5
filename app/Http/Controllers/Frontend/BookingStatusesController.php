...
class BookingStatusesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.bookingStatuses.index', compact('bookingStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.bookingStatuses.create');
    }
    ...
    public function store(StoreBookingStatusRequest $request)
    {
        ...
        return redirect()->route('frontend.booking-statuses.index');
    }
    ...
    public function edit(BookingStatus $bookingStatus)
    {
        ...
        return view('frontend.bookingStatuses.edit', compact('bookingStatus'));
    }
    ...
    public function show(BookingStatus $bookingStatus)
    {
        ...
        return view('frontend.bookingStatuses.show', compact('bookingStatus'));
    }
