...
class UserSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.userSettings.index', compact('userSettings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userSettings.create', compact('users'));
    }
    ...
    public function store(StoreUserSettingRequest $request)
    {
        ...
        return redirect()->route('frontend.user-settings.index');
    }
    ...
    public function edit(UserSetting $userSetting)
    {
        ...
        return view('frontend.userSettings.edit', compact('userSetting', 'users'));
    }
    ...
    public function show(UserSetting $userSetting)
    {
        ...
        return view('frontend.userSettings.show', compact('userSetting'));
    }
