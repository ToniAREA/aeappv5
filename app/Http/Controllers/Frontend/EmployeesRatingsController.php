...
class EmployeesRatingsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.employeesRatings.index', compact('employeesRatings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.employeesRatings.create', compact('employees', 'for_wlists', 'for_wlogs', 'from_clients', 'from_users'));
    }
    ...
    public function store(StoreEmployeesRatingRequest $request)
    {
        ...
        return redirect()->route('frontend.employees-ratings.index');
    }
    ...
    public function edit(EmployeesRating $employeesRating)
    {
        ...
        return view('frontend.employeesRatings.edit', compact('employees', 'employeesRating', 'for_wlists', 'for_wlogs', 'from_clients', 'from_users'));
    }
    ...
    public function show(EmployeesRating $employeesRating)
    {
        ...
        return view('frontend.employeesRatings.show', compact('employeesRating'));
    }
