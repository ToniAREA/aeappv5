...
class PaymentController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.payments.create', compact('currencies', 'financial_documents'));
    }
    ...
    public function edit(Payment $payment)
    {
        ...
        return view('frontend.payments.edit', compact('currencies', 'financial_documents', 'payment'));
    }
