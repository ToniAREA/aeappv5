...
class VideoCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.videoCategories.index', compact('videoCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.videoCategories.create', compact('authorized_roles', 'authorized_users'));
    }
    ...
    public function store(StoreVideoCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.video-categories.index');
    }
    ...
    public function edit(VideoCategory $videoCategory)
    {
        ...
        return view('frontend.videoCategories.edit', compact('authorized_roles', 'authorized_users', 'videoCategory'));
    }
    ...
    public function show(VideoCategory $videoCategory)
    {
        ...
        return view('frontend.videoCategories.show', compact('videoCategory'));
    }
