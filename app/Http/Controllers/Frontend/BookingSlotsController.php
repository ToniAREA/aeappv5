...
class BookingSlotsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.bookingSlots.index', compact('bookingSlots', 'booking_statuses', 'employees'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.bookingSlots.create', compact('employees', 'statuses'));
    }
    ...
    public function store(StoreBookingSlotRequest $request)
    {
        ...
        return redirect()->route('frontend.booking-slots.index');
    }
    ...
    public function edit(BookingSlot $bookingSlot)
    {
        ...
        return view('frontend.bookingSlots.edit', compact('bookingSlot', 'employees', 'statuses'));
    }
    ...
    public function show(BookingSlot $bookingSlot)
    {
        ...
        return view('frontend.bookingSlots.show', compact('bookingSlot'));
    }
