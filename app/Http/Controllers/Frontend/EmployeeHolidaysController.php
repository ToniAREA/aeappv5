...
class EmployeeHolidaysController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.employeeHolidays.index', compact('employeeHolidays'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.employeeHolidays.create', compact('employees'));
    }
    ...
    public function store(StoreEmployeeHolidayRequest $request)
    {
        ...
        return redirect()->route('frontend.employee-holidays.index');
    }
    ...
    public function edit(EmployeeHoliday $employeeHoliday)
    {
        ...
        return view('frontend.employeeHolidays.edit', compact('employeeHoliday', 'employees'));
    }
    ...
    public function show(EmployeeHoliday $employeeHoliday)
    {
        ...
        return view('frontend.employeeHolidays.show', compact('employeeHoliday'));
    }
