...
class FaqQuestionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.faqQuestions.index', compact('faqQuestions', 'faq_categories', 'roles', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.faqQuestions.create', compact('authorized_roles', 'authorized_users', 'categories'));
    }
    ...
    public function edit(FaqQuestion $faqQuestion)
    {
        ...
        return view('frontend.faqQuestions.edit', compact('authorized_roles', 'authorized_users', 'categories', 'faqQuestion'));
    }
