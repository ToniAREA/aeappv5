...
class ContentCategoryApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new ContentCategoryResource(ContentCategory::with(['authorized_roles', 'authorized_users'])->get());
    }
    ...
    public function show(ContentCategory $contentCategory)
    {
        ...
        return new ContentCategoryResource($contentCategory->load(['authorized_roles', 'authorized_users']));
    }
